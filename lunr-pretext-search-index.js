...
var ptx_lunr_docs = [
{
  ...
  "type": "Preface",
  "number": "",
  "title": "Students: How to Use these Notes",
  "body": " Students: How to Use these Notes  Welcome to MTH 132: Calculus I . These notes have been created to guide you through the course, to support your in-class learning, and to give you a resource for independent study and practice.  Structure of the Notes  The notes are divided into chapters and sections that match the topics of the course. Each section may contain:   Definitions of important concepts.  Theorems that summarize key results.  Examples to illustrate ideas and methods.  Remarks and alerts that highlight common pitfalls or important insights.  Exercises for you to practice and check understanding.   How to Approach Each Section  Here are some suggestions for making the most of each section:   Before class: Skim the definitions, theorems, and examples. Preview the exercises.  During class: Focus on interactive examples and problem-solving activities with your peers and instructor.  After class: Revisit the examples, complete the exercises, and check solutions or hints when provided.   Technology and Tools  These notes makes use of graphs, figures, and sometimes interactive elements (such as Desmos activities). A scientific calculator or graphing tool may be helpful, especially when you are first learning new concepts. That said, calculators should not replace understanding. The primary goal is to develop conceptual insight and the ability to carry out computations by hand. Be aware that calculator use may be restricted or not allowed at all on quizzes and exams, so practicing without a calculator an important part of your preparation.  Connections to Course Materials  These notes work alongside other course resources:   D2L for announcements, grades, and course structure.  WeBWorK for online homework practice.  Recitations and weekly reviews for collaborative practice.  Quizzes and exams for formal assessment.   Study Strategies  Some tips for success:   Practice actively : work through examples, don’t just read them.  Collaborate with classmates and discuss your reasoning.  Always show your work and leave answers in exact form when possible.  Interpret results and think about what they mean in context.   Accessibility and Flexibility  These notes have been designed with accessibility in mind. Figures include alt text, and the content can be navigated easily.  If you spot any errors or unclear explanations please let us know. We welcome suggestions for improvement and corrections via the Google Feedback Form .  Final Encouragement  Remember: these notes are a tool, not just a reference. Stay engaged, practice often, and combine them with the support of your instructors, TAs, and the Math Learning Center. With steady effort, you will succeed in calculus.  "
},
{
...
},
{
  "id": "ex-signs-basic",
  "level": "2",
  "url": "sec-precalc-basics.html#ex-signs-basic",
  "type": "Example",
  "number": "0.1.2",
  "title": "",
  "body": "  Simplify .      "
...
{
  "id": "ex-fractions-basic",
  "level": "2",
  "url": "sec-precalc-basics.html#ex-fractions-basic",
  "type": "Example",
  "number": "0.1.4",
  "title": "",
  "body": "  Simplify .      "
...
{
  "id": "ex-exponents-basic",
  "level": "2",
  "url": "sec-precalc-basics.html#ex-exponents-basic",
  "type": "Example",
  "number": "0.1.10",
  "title": "",
  "body": "  Simplify .      "
...
{
  "id": "ex-exponents-radical",
  "level": "2",
  "url": "sec-precalc-basics.html#ex-exponents-radical",
  "type": "Example",
  "number": "0.1.11",
  "title": "",
...
},
{
  ...
  "number": "0.1.13",
  "title": "",
  "body": "  Rationalize the denominator of .      "
},
{
...
},
{
  ...
  "number": "0.4",
  "title": "Inequalities",
  "body": " Inequalities  Inequalities appear throughout calculus, especially when describing domains, intervals of increase or decrease, and where functions are positive or negative. Unlike equations, inequalities often have many solutions. In this section, we focus on a single systematic approach, the test point method, which works reliably for many types of inequalities.  The key idea behind the test point method is simple. We first determine where an expression could change sign, then test representative points from each interval. This approach emphasizes understanding over memorization and reduces common algebra mistakes.    The Test Point Method: Overview  The test point method is used to solve inequalities of the form , , , or . Instead of solving directly, we analyze where the function is positive or negative.    To solve an inequality using test points:   Rewrite the inequality so that one side is zero.  Find all values of where the expression equals zero or is undefined.  Use these values to divide the number line into intervals.  Choose one test point from each interval and determine the sign of the expression.  State your conclusion: Determine which intervals satisfy the inequality.        Several Examples  Now let's see this modeled in several examples!   Linear Example   Solve . Write your answer in interval notation.     Step 1: Rewrite the inequality so one side is zero (already done).   Step 2: Identify where the expression equals zero or is undefined. There are no values of where the expression is undefined.   Step 3: Use to divide the number line into intervals and . Visually this looks like:   Number line divided at x equals 2.     Step 4: Choose a test point from each interval and determine the sign of the expression.  For the interval , we can test . Plugging this into our expression gives , which is negative.  For the interval , we can test . Plugging this into our expression gives , which is positive.  Visually, this looks like:   Number line divided at x equals 2. The interval to the left of 2 is labeled negative, while the interval to the right of 2 is labeled positive. Test points at x equals 0 and x equals 3 are marked with their respective signs.     Step 5: State your conclusion: Choose the interval(s) where the expression is positive.  The solution is . In interval notation, this is .     The test point method works best when the expression is factored. This is why factoring is a critical prerequisite for inequalities. Let's see how this plays out in the next example.    Quadratic Example   Solve . Write your answer in interval notation.     Step 1: Rewrite the inequality so one side is zero.    Step 2: Find all values of where the expression equals zero or is undefined.   There are no values of where the expression is undefined.   Step 3: Use these values to divide the number line into intervals.  The values and divide the number line into three intervals: , , and . Visually this looks like:   Number line divided at x equals 2 and x equals 3.     Step 4: Choose a test point from each interval and determine the sign of the expression.  For the interval , we can test . Plugging this into our expression gives , which is positive.  For the interval , we can test . Plugging this into our expression gives , which is negative.  For the interval , we can test . Plugging this into our expression gives , which is positive.  Visually, this looks like:   Number line divided at x equals 2 and x equals 3. The interval to the left of 2 is labeled positive, the interval between 2 and 3 is labeled negative, and the interval to the right of 3 is labeled positive. Test points at x equals 0, x equals 2.5, and x equals 4 are marked with their respective signs.     Step 5: State your conclusion: Choose the interval(s) where the expression is negative or zero (since the inequality is less than or equal to zero).  The expression is negative on the interval and equals zero at and . Since the inequality is less than or equal to zero, we include the endpoints. The solution is .    Rational inequalities require special care because the expression may be undefined for certain values of . As we saw in our technique, these values must always be considered when dividing the number line into intervals.   Rational Example   Solve . Write your answer in interval notation.     Step 1: Rewrite the inequality so one side is zero (already done).   Step 2: Identify where the expression equals zero or is undefined. The expression is undefined where the denominator is zero, which occurs at . To find where the expression equals zero, we set solve:     Step 3: Use these values to divide the number line into intervals. = The values , , and divide the number line into four intervals: , , , and . Visually this looks like:   Number line divided at x equals -2, x equals 0, and x equals 2.     Step 4: Choose a test point from each interval and determine the sign of the expression.  For the interval , we can test . Plugging this into our expression gives , which is positive.  For the interval , we can test . Plugging this into our expression gives , which is negative.  For the interval , we can test . Plugging this into our expression gives , which is negative.  For the interval , we can test . Plugging this into our expression gives , which is positive.  Visually, this looks like:   Number line divided at x equals -2, x equals 0, and x equals 2. The interval to the left of -2 is labeled positive, the interval between -2 and 0 is labeled negative, the interval between 0 and 2 is labeled negative, and the interval to the right of 2 is labeled positive. Test points at x equals -3, x equals -1, x equals 1, and x equals 3 are marked with their respective signs.     Step 5: State your conclusion: Choose the interval(s) where the expression is positive.  The expression is positive on the intervals and . The solution is .       Supplemental Video Resources  The following is a curated set of videos that many students find helpful. They provide additional explanations and worked examples for solving inequalities using the test point method.    Solving inequalities using sign charts    Polynomial inequalities using the test point method    Quadratic Inequalities    Rational inequalities using a sign chart     "
},
{
...
},
{
  "id": "ex-ineq-linear",
  "level": "2",
  "url": "sec-precalc-ineq.html#ex-ineq-linear",
  "type": "Example",
  "number": "0.4.2",
  "title": "Linear Example.",
  "body": " Linear Example   Solve . Write your answer in interval notation.     Step 1: Rewrite the inequality so one side is zero (already done).   Step 2: Identify where the expression equals zero or is undefined. There are no values of where the expression is undefined.   Step 3: Use to divide the number line into intervals and . Visually this looks like:   Number line divided at x equals 2.     Step 4: Choose a test point from each interval and determine the sign of the expression.  For the interval , we can test . Plugging this into our expression gives , which is negative.  For the interval , we can test . Plugging this into our expression gives , which is positive.  Visually, this looks like:   Number line divided at x equals 2. The interval to the left of 2 is labeled negative, while the interval to the right of 2 is labeled positive. Test points at x equals 0 and x equals 3 are marked with their respective signs.     Step 5: State your conclusion: Choose the interval(s) where the expression is positive.  The solution is . In interval notation, this is .   "
},
{
  "id": "rmk-ineq-factoring",
  "level": "2",
  "url": "sec-precalc-ineq.html#rmk-ineq-factoring",
  "type": "Remark",
  "number": "0.4.3",
  "title": "",
  "body": " The test point method works best when the expression is factored. This is why factoring is a critical prerequisite for inequalities. Let's see how this plays out in the next example.  "
},
{
  "id": "ssec-ineq-examples-5",
  "level": "2",
  "url": "sec-precalc-ineq.html#ssec-ineq-examples-5",
  "type": "Example",
  "number": "0.4.4",
  "title": "Quadratic Example.",
  "body": " Quadratic Example   Solve . Write your answer in interval notation.     Step 1: Rewrite the inequality so one side is zero.    Step 2: Find all values of where the expression equals zero or is undefined.   There are no values of where the expression is undefined.   Step 3: Use these values to divide the number line into intervals.  The values and divide the number line into three intervals: , , and . Visually this looks like:   Number line divided at x equals 2 and x equals 3.     Step 4: Choose a test point from each interval and determine the sign of the expression.  For the interval , we can test . Plugging this into our expression gives , which is positive.  For the interval , we can test . Plugging this into our expression gives , which is negative.  For the interval , we can test . Plugging this into our expression gives , which is positive.  Visually, this looks like:   Number line divided at x equals 2 and x equals 3. The interval to the left of 2 is labeled positive, the interval between 2 and 3 is labeled negative, and the interval to the right of 3 is labeled positive. Test points at x equals 0, x equals 2.5, and x equals 4 are marked with their respective signs.     Step 5: State your conclusion: Choose the interval(s) where the expression is negative or zero (since the inequality is less than or equal to zero).  The expression is negative on the interval and equals zero at and . Since the inequality is less than or equal to zero, we include the endpoints. The solution is .   "
},
{
  "id": "ex-ineq-rational",
  "level": "2",
  "url": "sec-precalc-ineq.html#ex-ineq-rational",
  "type": "Example",
  "number": "0.4.5",
  "title": "Rational Example.",
  "body": " Rational Example   Solve . Write your answer in interval notation.     Step 1: Rewrite the inequality so one side is zero (already done).   Step 2: Identify where the expression equals zero or is undefined. The expression is undefined where the denominator is zero, which occurs at . To find where the expression equals zero, we set solve:     Step 3: Use these values to divide the number line into intervals. = The values , , and divide the number line into four intervals: , , , and . Visually this looks like:   Number line divided at x equals -2, x equals 0, and x equals 2.     Step 4: Choose a test point from each interval and determine the sign of the expression.  For the interval , we can test . Plugging this into our expression gives , which is positive.  For the interval , we can test . Plugging this into our expression gives , which is negative.  For the interval , we can test . Plugging this into our expression gives , which is negative.  For the interval , we can test . Plugging this into our expression gives , which is positive.  Visually, this looks like:   Number line divided at x equals -2, x equals 0, and x equals 2. The interval to the left of -2 is labeled positive, the interval between -2 and 0 is labeled negative, the interval between 0 and 2 is labeled negative, and the interval to the right of 2 is labeled positive. Test points at x equals -3, x equals -1, x equals 1, and x equals 3 are marked with their respective signs.     Step 5: State your conclusion: Choose the interval(s) where the expression is positive.  The expression is positive on the intervals and . The solution is .   "
},
{
...
},
{
  ...
  "number": "0.6.9",
  "title": "",
  "body": " The function has the special property that its derivative is equal to itself ( we will be learning about derivatives in this Calculus course ). Because of this, it is often simpler to work with base .  "
},
{
  "id": "ssec-base-e-5",
  "level": "2",
...
},
{
  ...
  "body": " Sine and Cosine (Right Triangle)   Given a right triangle and an acute angle ,     A right triangle illustrating the definitions of sine and cosine for an acute angle .   A right triangle labeled with opposite, adjacent, and hypotenuse sides, illustrating the Pythagorean theorem.     "
},
{
  "id": "ex-trig-right-triangle",
  "level": "2",
  "url": "sec-precalc-trig.html#ex-trig-right-triangle",
  "type": "Example",
  "number": "0.8.3",
  "title": "",
...
},
{
  "id": "rmk-trig-acute",
  "level": "2",
  "url": "sec-precalc-trig.html#rmk-trig-acute",
  "type": "Remark",
  "number": "0.8.4",
  "title": "",
...
},
{
  ...
  "body": " Sine and Cosine (Unit Circle)   Consider the unit circle centered at the origin. For a real number , let the point on the unit circle corresponding to angle (measured in radians) have coordinates . Then     The unit circle definition of sine and cosine. For an angle , the point on the unit circle satisfies , , and .   Unit circle diagram showing a point (cos(theta), sin(theta)) and illustrating the identity cos^2(theta) + sin^2(theta) = 1     "
},
{
...
{
  "id": "ex-unit-circle-values",
  "level": "2",
  "url": "sec-precalc-trig.html#ex-unit-circle-values",
  "type": "Example",
  "number": "0.8.8",
  "title": "",
  "body": "  Evaluate and .      "
...
{
  "id": "rmk-trig-definitions-agree",
  "level": "2",
  "url": "sec-precalc-trig.html#rmk-trig-definitions-agree",
  "type": "Remark",
  "number": "0.8.9",
  "title": "",
...
{
  "id": "rmk-trig-periodicity",
  "level": "2",
  "url": "sec-precalc-trig.html#rmk-trig-periodicity",
  "type": "Remark",
  "number": "0.8.10",
  "title": "",
...
{
  "id": "rmk-trig-undefined",
  "level": "2",
  "url": "sec-precalc-trig.html#rmk-trig-undefined",
  "type": "Remark",
  "number": "0.8.12",
  "title": "",
...
{
  "id": "ex-unit-circle-values2",
  "level": "2",
  "url": "sec-precalc-trig.html#ex-unit-circle-values2",
  "type": "Example",
  "number": "0.8.13",
  "title": "",
...
{
  "id": "ex-unit-circle-values3",
  "level": "2",
  "url": "sec-precalc-trig.html#ex-unit-circle-values3",
  "type": "Example",
  "number": "0.8.14",
  "title": "",
...
{
  "id": "rmk-sin-cos-range",
  "level": "2",
  "url": "sec-precalc-trig.html#rmk-sin-cos-range",
  "type": "Remark",
  "number": "0.8.16",
  "title": "",
...
{
  "id": "rmk-pythagorean-identities",
  "level": "2",
  "url": "sec-precalc-trig.html#rmk-pythagorean-identities",
  "type": "Remark",
  "number": "0.8.18",
  "title": "",
...
{
  "id": "ex-pythagorean-identity",
  "level": "2",
  "url": "sec-precalc-trig.html#ex-pythagorean-identity",
  "type": "Example",
  "number": "0.8.19",
  "title": "",
  "body": "  Simplify the expression .      "
...
},
{
  "id": "ex-angle-sum",
  "level": "2",
  "url": "sec-precalc-trig.html#ex-angle-sum",
  "type": "Example",
  "number": "0.8.22",
  "title": "",
  "body": "  Simplify .    We can use the angle sum formula for sine:    "
},
{
...
},
{
  ...
  "number": "1.1.2",
  "title": "",
  "body": " Reading a limit from a graph: .   Graph of a smooth increasing function labeled y = f(x). A point on the curve highlights a value that the function approaches as x approaches a nearby input, illustrating the idea of a limit.    "
},
{
  "id": "ex-0001",
  "level": "2",
  ...
  "body": " Our First Limit   Consider the function   Using a calculator, evaluate the function at the indicated -values and fill in the corresponding entries in the table.    Based on the intuitive limit definition guess the limit value      View the graph of in Desmos . Use words to explain to another student how the table relates to the graph and how the limit can be determined from the graph.             As gets closer and closer to , the output values get closer and closer to . Thus, we can guess that the limit value is , so that   As approaches from either the left or the right, the output values get closer and closer to . Although is undefined (there is a hole in the graph), the limit still exists and equals .     "
},
{
...
},
{
  ...
  "number": "1.1.5",
  "title": "",
  "body": " The limit does not exist GIF    Animated GIF showing a person looking shocked and puzzled, often used humorously when a math problem produces an unexpected outcome.   "
},
{
  ...
  "body": " When a limit does not exist   Consider the sign function , defined by   Which when graphed looks like:    The sign function .   Plot representing the sign function sgn(x). The function takes the value 1 for x greater than 0 and −1 for x less than 0, and is not defined at x = 0.      Determine the limit     Near , the function cannot be forced close to any single output value. That is, , since no matter how close gets to , there are some (namely negative) for which is far from ; and similarly is not , nor , nor any other value. In such cases, it is most appropriate to simply say does not exist.   "
},
{
...
},
{
  ...
  "number": "1.1.17",
  "title": "",
  "body": "  Consider the function .  Which when graphed looks like:   The graph of .   Graph showing a function approaching a vertical asymptote. As x approaches a specific value, the function increases without bound, illustrating an infinite limit.     Answer the following questions.   Using the graph of evaluate and explain your reasoning.  Try now without the graph (using only the equation of ) to evaluate and explain your reasoning.       Looking at the graph , we can notice two key features near :   The graph is in two pieces — one in quadrant II (for ) and one in quadrant I (for ).  Both pieces shoot straight up as they get close to .   This means the function grows beyond any large number we can choose when is close enough to . And so we know     As gets very close to , gets very small — like , , , and so on. Dividing by a very small positive number gives a very large positive number (for example, , , ). In general, we can shorthand this fact as .     "
},
{
...
},
{
  ...
  "number": "1.2.11",
  "title": "",
  "body": " The function (solid) squeezed between (dashed).   Graph illustrating the Squeeze Theorem near x=1. A wavy curve labeled y = x + 4(x-1)^2 sin(1\/(x-1)) oscillates between two dashed curves labeled y = x - 4(x-1)^2 and y = x + 4(x-1)^2, and all three approach the point (1,1).    "
},
{
  "id": "ssec-squeeze-6",
  "level": "2",
...
},
{
  ...
  "number": "8",
  "title": "",
  "body": "  .   False. There is no need to factor and cancel here, since the limit can be evaluated by direct substitution: .   "
},
{
...
},
{
  ...
  "number": "1.3.2",
  "title": "",
  "body": " A function approaching the horizontal asymptote as .   Graph of a function approaching a dashed horizontal line as x increases. The dashed line represents a horizontal asymptote that the curve approaches but does not reach.   "
},
{
  ...
  "number": "1.3.3",
  "title": "",
  "body": " A function that increases without bound and does not approach a horizontal asymptote.   Graph of a function that increases without bound as x increases. The curve continues rising and does not level off, illustrating a function with no horizontal asymptote.   "
},
{
...
},
{
  ...
  "number": "1.4.2",
  "title": "",
  "body": "  A function has a removable discontinuity at if exists but is either undefined or does not equal that limit.   Graphically, a removable discontinuity appears as a hole in the curve at . The discontinuity is \"removable\" because we can redefine to equal the limit, making the function continuous at .   Two examples of removable discontinuities: one where is undefined, and one where the value does not equal the limit.    Graph of a smooth increasing curve with an open circle at x = a. The curve approaches the same value from both sides, but the point (a, f(a)) is missing, illustrating a removable discontinuity.    Graph of a smooth increasing curve with a hole at x = a and a filled point directly above it. The open circle shows the limit value of the function at x = a, while the filled point indicates that f(a) is defined at a different value, illustrating a removable discontinuity.     "
},
{
...
},
{
  ...
  "number": "1.4.6",
  "title": "",
  "body": "  A function has a jump discontinuity at if the left and right limits exist but are unequal:    Graphically, a jump discontinuity appears as a sudden jump in the curve at .   A jump discontinuity where left and right limits differ.   Graph of a function with a jump discontinuity at x = a. The curve approaching from the left ends at an open circle, while a filled point above it shows the value of the function and the branch for x greater than a.    "
},
{
...
},
{
  ...
  "number": "1.4.9",
  "title": "",
  "body": "  A function has an infinite discontinuity at if one or both one-sided limits diverge to infinity:    Graphically, an infinite discontinuity appears as a vertical asymptote in the curve at .   A discontinuity caused by a vertical asymptote.   Graph of a function with a vertical asymptote at x = a. The curve approaches negative infinity from the left and positive infinity from the right, illustrating an infinite discontinuity.    "
},
{
  "id": "ex-infinite-abs",
  "level": "2",
...
},
{
  ...
  "number": "1.4.12",
  "title": "",
  "body": "  A function has an essential discontinuity at if one or both one-sided limits fail to exist in any sense.   Graphically, an essential discontinuity quite often appears as a wild oscillation in the curve at .   An essential discontinuity where one-sided limits fail to exist.   Graph of a function that oscillates increasingly rapidly near x = a. As x approaches a, the function does not approach a single value but instead fluctuates between many values, illustrating an essential discontinuity.    "
},
{
...
},
{
  ...
  "number": "2.1.6",
  "title": "",
  "body": " A secant line connecting the points and , representing the average rate of change of on the interval .   Graph of a curve f(x) with a straight line passing through two points on the curve labeled (1, f(1)) and (7, f(7)). The line represents the secant line connecting these two points.   "
},
{
  "id": "def-secant-slope",
  "level": "2",
...
},
{
  ...
  "number": "2.1.9",
  "title": "",
  "body": " A tangent line through the point , representing the instantaneous rate of change of at .   Graph of a curve f(x) with a straight line tangent to the curve at the point (1, f(1)). The line represents the tangent line at that point.   "
},
{
...
},
{
  ...
  "number": "3.2.2",
  "title": "",
  "body": " Related rates problems often involve geometric relationships, such as those found in triangles, circles, or other shapes. Some students find that every problem feels a bit different, but the overall method remains consistent across various scenarios.  "
},
{
...
},
{
  ...
  "number": "4",
  "title": "",
  "body": "  If , then must have either a local maximum or local minimum at .     False . If , it means that the tangent line to the graph of at is horizontal, but that does not necessarily imply that there is a local maximum or minimum at that point. For example, the function has a critical point at where the derivative is zero, but it is neither a local maximum nor a local minimum.   "
},
{
  "id": "ex-extrema-tf-08",
  "level": "2",
...
{
  "id": "rmk-opt-true-false",
  "level": "2",
  "url": "sec-derivApp-opt.html#rmk-opt-true-false",
  "type": "Remark",
  "number": "3.8.13",
  "title": "",
...
},
{
  ...
  "number": "3.9",
  "title": "Additional Worked-Out Problems",
  "body": " Additional Worked-Out Problems   Motion in Physics    The position of a particle moving along a line is given by   where is measured in meters and in seconds.  (a) Find all times when the velocity equals .  (b) Determine whether the particle is moving to the right or to the left at .  (c) Find all times when the particle has acceleration .    (a) The velocity is the derivative of the position function:   Setting the velocity equal to zero gives   Thus, the velocity equals zero at and .  (b) To determine the direction of motion at , we can evaluate the velocity at :   Since , the particle is moving to the right at .  (c) The acceleration is the derivative of the velocity function:   Setting the acceleration equal to gives   So the particle has acceleration at .      A particle moves vertically according to , where is measured in meters, in seconds, and is a positive constant.  If the particle reaches maximum height at seconds, find:  (a) the value of .  (b) the maximum height reached.    (a) The velocity is the derivative of the position function:   Since the particle reaches maximum height at , the velocity must equal zero at :   (b) To find the maximum height, we can evaluate the position function at using the value of we just found:   So the maximum height reached is meters.      One of the curves below represents the graph of a position function, and the other curve represents the graph of the corresponding velocity function. Which curve is which?   A graph with two curves (one solid red and one dashed blue) plotted against time. The dashed curve has a local minimum and a local maximum, while the solid curve crosses the t-axis at the same t-values where the dashed curve has horizontal tangents.     First consider the possibility that the solid red curve is the graph of . If that is the case, then the graph of the derivative (the velocity function) must satisfy:    The graph of must pass through , since the solid red curve has a horizontal tangent at .    The graph of must be above the -axis for , since the solid red curve is increasing there.    The graph of must be below the -axis for , since the solid red curve is decreasing there.    Although the dashed blue curve may pass through , the rest of these sign conditions do not match it. Therefore, the solid red curve cannot be .  Next, assume the dashed blue curve is the position function . Let and be the -values where the dashed blue curve has its local minimum and local maximum, respectively. Then the derivative (the velocity function) must satisfy:    The graph of must cross the -axis at and , since the dashed blue curve has horizontal tangents at those points.    The graph of must be above the -axis on , since the dashed blue curve is increasing there.    The graph of must be below the -axis for and for , since the dashed blue curve is decreasing on those intervals.    This description matches the solid red curve. Therefore, the dashed blue curve is and the solid red curve is .      The graph below shows the velocity of a particle moving along a horizontal line for the open interval .   A piecewise linear graph of velocity v versus time t on the interval (0,10). The graph is below the t-axis for early times, crosses v=0 at t=2, stays above the axis until t=7, lies on v=0 from t=7 to t=9, and then rises above the axis again from t=9 to t=10. Several corners indicate times where the slope changes abruptly.   (a) When does the particle move forward?  (b) When does the particle slow down?  (c) When is the particle’s acceleration positive?  (d) When does the particle stand still for more than an instant?    (a) The particle moves forward when , meaning the velocity graph is above the -axis. From the graph, this occurs on .  (b) The particle slows down when its speed is decreasing. If (moving forward), slowing down means is decreasing, so . If (moving backward), slowing down means is increasing toward zero, so .  From the graph, on and the velocity is increasing there, so the particle slows down on . Also, on and the velocity is decreasing on , so the particle slows down on . Therefore, the particle slows down on .  At times where the velocity graph has corners, the derivative (acceleration) is not defined, so those times should not be included.  (c) The acceleration is positive when , meaning the velocity graph has positive slope. From the graph, this occurs on (excluding any corner points).  (d) The particle stands still when . From the graph, this happens at and for . Standing still for more than an instant means an interval of time, so the answer is .      Related Rates    A computer animator creates a circle for which the area of the circle increases at the rate of . Find the rate of change of the circumference of the circle at the time that the radius is mm.    Let , , and denote the changing area, radius, and circumference of the circle at time .  We are given the rate of change of the area:   We are also told that at a particular time, say ,   Our goal is to determine   The circumference of a circle is related to the radius by   Differentiating both sides with respect to gives   Therefore, at time ,   To determine , we relate the radius to the area. The area of a circle is   Differentiating with respect to ,   Solve for :   Substitute the known values at :   Now substitute this into the expression for :   Therefore, when the radius is mm, the circumference is increasing at a rate of mm\/sec.      A hot air balloon is released from its launching area and watched by a crowd in a viewing area feet away from the launch site. What is the vertical speed of the balloon when its distance from the viewing area is feet and that distance is increasing at a rate of ft\/hr?    Let denote the changing height of the balloon and let denote the changing distance from the balloon to the viewing area.  At a particular instant, say , we are given   We want to determine the vertical speed of the balloon at that time:   The viewing area, launch site, and balloon form a right triangle. The base of the triangle is ft, the height is , and the hypotenuse is . By the Pythagorean Theorem,   Differentiate both sides with respect to :   Solving for ,   To evaluate this at , we still need the value of . Using the original relationship,   Solve for the height:   Now substitute the known quantities into the formula for :   Simplifying,   Therefore, when the balloon is feet from the viewing area, its vertical speed is ft\/hr.      A spotlight is on the ground ft away from a wall and a ft tall person is walking toward the wall at a rate of ft\/sec.  How fast is the height of the shadow changing when the person is ft from the wall?   A spotlight on the ground shines toward a wall 20 feet away. A person stands between the spotlight and the wall, casting a shadow on the wall. The person is 6 feet tall. The distance from the spotlight to the person is labeled x, the distance from the person to the wall is 20 minus x, and the height of the shadow on the wall is labeled y.      Let   be the distance of the person from the spotlight,  be the distance of the person from the wall, and  be the height of the shadow on the wall.   Because the wall is ft from the spotlight,   The person is walking toward the wall at a rate of ft\/sec, so   At the instant of interest,   We want to determine the rate of change of the height of the shadow:   From the geometry of the situation there are two similar triangles: the large triangle formed by the spotlight and the shadow on the wall, and the smaller triangle formed by the spotlight and the person. Using similar triangles,   Solving for ,   Differentiate with respect to :   To determine , differentiate the relationship :   Since ,   Now evaluate the derivative when :   Therefore the height of the shadow is changing at a rate of ft\/sec. The negative sign indicates that the height of the shadow is decreasing at that moment.      A flexible cylinder has been built which can change its volume by changing its height or its radius. However, design constraints require that its height is always twice its radius.  Find the rate of change of the volume of the cylinder when its radius is feet and the radius is increasing at a rate of ft\/min.    Let denote the changing radius of the cylinder, denote the changing height, and denote the volume.  We are given the design constraint   At a particular time, say ,   We want to determine the rate of change of the volume at that same time:   The volume of a cylinder is   Using the relationship , we can rewrite the volume in terms of the radius alone:   Differentiate with respect to :   Now evaluate this derivative at :   Therefore, when the radius is ft, the volume is increasing at a rate of       A factory produces solar panels according to the production function   where represents thousands of dollars spent on labor and represents thousands of dollars spent on equipment.  (a) How many panels are produced when and ?  (b) The company keeps equipment spending fixed at . At what rate is production changing with respect to labor spending when ?    Part (a)  Substitute the given values into the production function.   Without a calculator we would leave the answer in this form, but since this is an example exercise we can compute the powers to get a numerical approximation.   Thus the factory produces approximately solar panels.  Part (b)  Since equipment spending is fixed at , we can plug that in, leaving our only variable .   Now evaluate at .   Again, if we did not have access to a calculator this is how we would leave our final answer (WeBWorK would accept this as well). However since this is an example exercise, we can compute the powers to get a numerical approximation.   Therefore production is increasing at approximately panels per additional thousand dollars spent on labor.      Linear Approximation and L'Hopital's Rule    The equation   has a solution near . Approximate this solution by replacing the left-hand side with its linearization at and then solving the resulting equation.    Let   We approximate near using its linearization   First compute the value of the function at .   Next compute the derivative.   Evaluate the derivative at .   Therefore the linearization of at is   We now approximate the equation by solving     Thus an approximate solution to the equation is   If we have access to technology, we can check how good this approximation is by evaluating the original expression at . Doing so gives a value very close to , confirming that the linear approximation produced a reasonable estimate.  While this type of numerical check can be helpful for building intuition and verifying results, it is important to note that calculators may not be available on quizzes or exams. In those situations the goal is simply to use linearization to produce a reasonable approximation based on calculus rather than numerical computation.      A phone’s battery range (in hours) depends on temperature (in degrees Fahrenheit). A test reports and .  (a) Estimate using the average rate of change from to .  (b) Write the linear approximation to near .  (c) Use your linear approximation to estimate .  (d) Interpret the meaning of in a sentence, including units.     Part (a) : Use the slope of the secant line from to as an estimate for :   So hours per degree Fahrenheit.   Part (b) : The linearization (tangent line approximation) at is   Using and our estimate , we get    Part (c) : Estimate by evaluating :   So the battery range at F is approximately hours.   Part (d) : The value hours per F means that near F, increasing the temperature by F decreases the battery range by about hours (about minutes).      Extrema    Find all critical numbers of the function     Recall that the critical numbers of a function are the values of in the domain of for which either or is undefined.  Rewrite the function using exponents:   Differentiate:   Finding a common denominator gives   To determine where , set the numerator equal to zero:    Next determine where the derivative is undefined by examining the denominator. The denominator is zero when    However, the original function is not defined at , so this value is not in the domain of and therefore cannot be a critical number.  Thus the only critical number of the function is       Find all critical numbers of the function     Recall that the critical numbers of a function are the values of in the domain of for which either or is undefined.  We begin by computing the derivative using the quotient rule.   Factor the numerator.   To find where , we set the numerator equal to zero:      Next we determine where the derivative is undefined by examining the denominator. The denominator is zero when   However, for all real numbers , so the denominator can never be zero. Therefore is defined for all real .  Thus the critical numbers of are       Consider the graph of below on the interval .   A graph of f(x) on a square grid from 0 to 5. Starting at (0,3), the function curves upward to a maximum at (1,4), then curves downward passing through (2,3) and reaching a minimum at (3,1). After x = 3, the graph is a straight line segment increasing to (5,5).    (a) Identify the critical numbers of and explain how you know they are critical numbers.  (b) Identify the absolute maximum and minimum values of and the -values where they occur.     Part (a) : The critical numbers of are the values of where the derivative is zero or undefined. From the graph, we can see that the function has a horizontal tangent at and a corner at . Therefore, the critical numbers of are    Part (b) : The absolute maximum value of on the interval is , which occurs at . The absolute minimum value of on the interval is , which occurs at .      Consider the function   Determine the absolute maximum and minimum values of and the -values where these extrema occur.    First determine the critical numbers of . Compute the derivative.   Setting gives   Thus the critical numbers are   To determine the absolute extrema on the interval , we evaluate at the endpoints and at any critical numbers inside the interval. Since lies outside the interval, we only check , , and .   Comparing these values, the absolute maximum value of is which occurs at .  The absolute minimum value of is which occurs at .      Consider the function   Determine the absolute maximum and minimum values of and the -values where these extrema occur.    When a function involves absolute values, it is often helpful to rewrite it using the definition of absolute value:   For this function,   Taking derivatives of each piece gives   The derivative at is undefined. Indeed,   and this limit does not exist. Thus the only critical number is   To determine the absolute extrema on the interval , evaluate at the critical number and the endpoints.   Therefore, the absolute maximum value of is , which occurs at . The absolute minimum value of is , which occurs at .      Consider the function   Determine the absolute maximum and minimum values of and the -values where these extrema occur.    First determine the critical numbers of . Compute the derivative.   To determine where , solve   Multiply both sides by :     Next determine where the derivative is undefined. The derivative is undefined when    Thus the critical numbers are and . However, only lies in the interval .  To determine the absolute extrema on , evaluate at the endpoints and the critical number in the interval.   Comparing these values, the absolute maximum value of is , which occurs at . The absolute minimum value of is , which occurs at .      Mean Value Theorem    Show that the function   on the interval satisfies the conditions of Rolle’s Theorem. Then find a value for which .    The function is a polynomial, so it is continuous for all real numbers and differentiable for all real numbers. Therefore it is continuous on the closed interval and differentiable on the open interval .  Next evaluate the function at the endpoints.   Since , all of the conditions of Rolle’s Theorem are satisfied. Therefore there must exist at least one such that   To find such a value, compute the derivative.   Now solve .     Of these solutions, only   lies in the interval . Therefore this value satisfies the conclusion of Rolle's Theorem.      Consider the function   Verify that the Mean Value Theorem applies, and find a value for which     The function is a polynomial, so it is continuous for all real numbers and differentiable for all real numbers. Therefore it is continuous on the closed interval and differentiable on the open interval . Thus the conditions of the Mean Value Theorem are satisfied.  First compute the average rate of change of on .   Next compute the derivative of .   To find , solve      Since must lie in the interval , we discard the negative solution. Therefore   This value lies in the interval , so it satisfies the conclusion of the Mean Value Theorem.      Consider the function   Verify that the Mean Value Theorem applies, and find a value for which     The function is a rational function, so it is differentiable wherever the denominator is nonzero. Since for all , the function is continuous on the closed interval and differentiable on the open interval . Therefore the conditions of the Mean Value Theorem are satisfied.  First compute the average rate of change of on the interval.   Next compute the derivative of .   To find , solve       Since must lie in the interval , we discard the negative solution. Therefore   Since , this value satisfies the conclusion of the Mean Value Theorem.      Curve Sketching Part 1    Let .  (a) Find the critical number(s) of .  (b) Determine the intervals where is increasing and decreasing.  (c) Find the local maxima and minima of .    (a) First rewrite the absolute value as a piecewise function.   The domain of is all real numbers.  The derivative on each interval is   The derivative does not exist at , so this is a critical number.  (b) Since for and for , the function increases on the interval and decreases on the interval .  (c) By the First Derivative Test, since changes from positive to negative at , the function has a local maximum at . There are no local minima.      Consider on the interval .  (a) Find the critical number(s) of .  (b) Determine the intervals where is increasing and decreasing.  (c) Find the local maxima and minima of .    (a) To find the critical numbers, compute the derivative.   This is always defined, so the only critical numbers will come from , solve   Of these solutions, only and lie in the interval , so these are the critical numbers.  (b) To determine where the function is increasing and decreasing, we can use the critical numbers to divide the interval into three subintervals: , , and . We can test a point in each interval to determine the sign of the derivative.  For , , so the function is increasing on .  For , , so the function is decreasing on .  For , , so the function is increasing on .  (c) By the First Derivative Test, since changes from positive to negative at , the function has a local maximum at . Since changes from negative to positive at , the function has a local minimum at .      Consider the function .  (a) Find the critical number(s) of .  (b) Determine the intervals where is increasing and decreasing.  (c) Find the local maxima and minima of .  (d) Determine the intervals where is concave up and concave down, and find any inflection points.  (e) Sketch the graph of using the information from parts (a)-(d).    (a) To find the critical numbers, compute the derivative.   This is always defined, so the only critical numbers will come from , solve   Thus the only critical number is .  (b) To determine where the function is increasing and decreasing, we can use the critical number to divide the interval into two subintervals: and . We can test a point in each interval to determine the sign of the derivative.  For , , so the function is increasing on .  For , , so the function is decreasing on .  (c) By the First Derivative Test, since changes from positive to negative at , the function has a local maximum at . There are no local minima.  (d) To determine where the function is concave up and concave down, compute the second derivative.   This is always defined, so the only points of inflection will come from , solve   To determine the concavity, we can divide the interval into two subintervals: and . We can test a point in each interval to determine the sign of the second derivative.  For , , so the function is concave down on .  For , , so the function is concave up on .  Thus the function is concave down on and concave up on , and there is an inflection point at .  (e) To sketch the graph of , we can use the information from parts (a)-(d).   , so the graph passes through the point .  The function is increasing on and decreasing on .  There is a local maximum at .  The function is concave down on and concave up on .  There is an inflection point at .    Combining all this we can sketch the graph of .   A graph of f(x)=xe^(-x). The graph starts at (0,0), increases to a local maximum at x=1, then decreases and has an inflection point at x=2, after which it continues to decrease but is concave up.       Curve Sketching Part 2    Let .  Analyze the function by determining the following.    Domain of .    Any vertical or horizontal asymptotes.    Whether is even, odd, or neither.    Intervals where is increasing and decreasing.    All critical points and classify them as local maxima, local minima, or neither.    Intervals of concavity and any inflection points.    Use the information above to sketch the graph of .      (a) The function is a polynomial, so it is defined for all real numbers. Thus the domain is .  (b) Since the function is defined for all real numbers, there are no vertical asymptotes. To find horizontal asymptotes, we can compute the limits as .   Thus there are no horizontal asymptotes.  (c) To determine symmetry, we can check whether or .   Since and , the function is neither even nor odd.  (d) To determine where the function is increasing and decreasing, we can compute the derivative and find the critical points.   The derivative is defined for all real numbers, and to find where the derivative is zero, we can solve   Thus the critical points are and .  To determine where the function is increasing and decreasing, we can use the critical points to divide the interval into three subintervals: , , and . We can test a point in each interval to determine the sign of the derivative.  For , , so the function is decreasing on .  For , , so the function is increasing on .  For , , so the function is decreasing on .  (e) By the First Derivative Test, since changes from negative to positive at , the function has a local minimum at . Since changes from positive to negative at , the function has a local maximum at .  (f) To determine where the function is concave up and concave down, compute the second derivative.   This is defined for all real numbers, so the only points of inflection will come from , solve   So the only point of inflection is at .  To determine the concavity, we can divide the interval into two subintervals: and . We can test a point in each interval to determine the sign of the second derivative.  For , , so the function is concave up on .  For , , so the function is concave down on .  Thus the function is concave up on and concave down on , and there is an inflection point at .  (g) To sketch the graph of , we can use the information from parts (a)-(f).   , so the graph passes through the point .  There is no symmetry or asymptotes.  The function is decreasing on , increasing on , and decreasing on .  There is a local minimum at and a local maximum at .  The function is concave up on and concave down on .  There is an inflection point at .    Combining all this we can sketch the graph of .   A graph of f(x)=-2x^3+24x-5. The graph has a local minimum at x=-2, a local maximum at x=2, and an inflection point at x=0. The graph is concave up on (-infinity,0) and concave down on (0,infinity).       Let .    Determine the domain of .    Determine any vertical or horizontal asymptotes.    Determine whether has any symmetry (even\/odd\/neither).    Determine the intervals where is increasing and decreasing.    Find and classify all critical points (local maxima, local minima, or neither).    Determine the intervals where is concave up and concave down, and identify any inflection points.    Use the information above to sketch the graph of .      (a) The function is defined for all real numbers, so the domain is .  (b) There are no vertical asymptotes since the function is defined for all real numbers. To find horizontal asymptotes, we can compute the limits as .   Thus there are no horizontal asymptotes.  (c) To determine symmetry, we can check whether or .   Since and , the function is neither even nor odd.  (d) To determine where the function is increasing and decreasing, we can compute the derivative and find the critical points.   The derivative is undefined at , and to find where the derivative is zero, we can solve   Thus the critical points are and .  To determine where the function is increasing and decreasing, we can use the critical points to divide the interval into three subintervals: , , and . We can test a point in each interval to determine the sign of the derivative.   For , , so the function is decreasing on .  For , , so the function is decreasing on .  For , , so the function is increasing on .   Therefore the function is decreasing on and , and increasing on .  (e) To find and classify the critical points, we can use the First Derivative Test.  At , the derivative changes from negative to negative, so there is neither a local maximum nor a local minimum at .  At , the derivative changes from negative to positive, so there is a local minimum at .  Thus there is a local minimum at .  (f) To determine where the function is concave up and concave down, we can compute the second derivative and find the inflection points.   The second derivative is undefined at , and to find where the second derivative is zero, we can solve   Thus the possible points of inflection are and but we need to check if they change concavity by testing the sign of the second derivative in each interval.  To determine the concavity of the function, we can use the possible points of inflection to divide the interval into three subintervals: , , and . We can test a point in each interval to determine the sign of the second derivative.   For , , so the function is concave up on .  For , , so the function is concave down on .  For , , so the function is concave up on .   Therefore the function is concave up on and , and concave down on . There are inflection points at and .  (g) To sketch the graph of , we can use the information from parts (a)-(f).  The domain is all real numbers.  There are no asymptotes.  The function is neither even nor odd.  The function is decreasing on and , and increasing on .  There is a local minimum at .  The function is concave up on and , and concave down on . There are inflection points at and .    Combining all this we can sketch the graph of .   A graph of f(x)=x^(1\/3)(x-3). The graph decreases and is concave up on (-infinity, -3\/2), continues to decrease but is now concave down on (-3\/2, 0), continues to decrease and is concave up on (0, 3\/4), then increases and is concave up on (3\/4, infinity). There is a local minimum at x=3\/4, and inflection points at x=-3\/2 and x=0.       Optimization Problems   Maximizing the Area of a Triangle Formed with the Axes   Find the point on the curve in the first quadrant that forms a triangle with the coordinate axes having the largest possible area.   A graph of the curve y=6-x^2. A point (x,y) on the curve forms a triangle with the x axis, and we want to find the point that maximizes the area of this triangle.      Let be a point on the curve in the first quadrant. This point, together with the coordinate axes, forms a right triangle with vertices and .  The base of the triangle is and the height is , so the area is   Since the point lies on the curve , we substitute to write the area as a function of :   Simplifying,   Because the point lies in the first quadrant, we require and . From , we obtain   To find the maximum area, differentiate:   Set the derivative equal to zero:   Since we are in the first quadrant, we take the positive value .  Now find the corresponding -value:   Thus the point on the curve is .  To confirm this gives a maximum, compute the second derivative:   Since , the area function is concave down at this point, so the area is maximized there.  The maximum area is       A ladder of length feet is leaning against a wall. The foot of the ladder is being pulled away from the wall, and we want to determine how to pull the ladder to maximize the area of the triangle formed by the ladder, the wall, and the ground.    Find an equation for the area of the triangle that only relies on the variable (the distance from the wall to the foot of the ladder).  What is the largest possible area of such a triangle, and what are the lengths of the legs when the area is maximized?      (a) Since the triangle is right, the legs and and the hypotenuse satisfy the Pythagorean Theorem:   Solving for , we get   The area of a right triangle is   Substituting gives   where .  (b) To maximize the area, we differentiate:   Using the product rule,   Simplifying,   Combine the terms into a single fraction:   Critical points occur when or when is undefined. On the interval , the denominator is positive, so we set the numerator equal to zero:      Since must be positive, we take .  To confirm this gives a maximum, we will use the Closed Interval Test. We will evaluate the area at the critical point and at the endpoints of the interval.   Thus the maximum area is square feet, and this occurs when . To find the corresponding value of , we can substitute into the Pythagorean Theorem:   Therefore the area is maximized when the legs of the triangle are both feet.      A box with a square base and no top must have a volume of cubic inches.   A 3D rectangular box with a square base. The base edges are labeled x, and the vertical edge is labeled y, indicating the height of the box.      Write the surface area of the box as a function of the base side length .    Find the dimensions of the box that minimize the amount of material used.      (a) Let be the side length of the square base and be the height of the box. The volume is given by   Solving for , we obtain   Since the box has no top, the surface area consists of the base and four sides:   Substituting gives   Simplifying,   (b) To minimize the surface area, differentiate:   Set the derivative equal to zero:   Now find the height:   To show that the surface area is minimized at this critical point, we can compute the second derivative:   Plugin in gives .  So this critical point gives a minimum.  Therefore, the dimensions that minimize the amount of material used are      "
},
{
...
{
  "id": "ex-production-solar-panels",
  "level": "2",
  "url": "sec-derivApp-ww.html#ex-production-solar-panels",
  "type": "Example",
  "number": "3.9.9",
  "title": "",
  "body": "  A factory produces solar panels according to the production function   where represents thousands of dollars spent on labor and represents thousands of dollars spent on equipment.  (a) How many panels are produced when and ?  (b) The company keeps equipment spending fixed at . At what rate is production changing with respect to labor spending when ?    Part (a)  Substitute the given values into the production function.   Without a calculator we would leave the answer in this form, but since this is an example exercise we can compute the powers to get a numerical approximation.   Thus the factory produces approximately solar panels.  Part (b)  Since equipment spending is fixed at , we can plug that in, leaving our only variable .   Now evaluate at .   Again, if we did not have access to a calculator this is how we would leave our final answer (WeBWorK would accept this as well). However since this is an example exercise, we can compute the powers to get a numerical approximation.   Therefore production is increasing at approximately panels per additional thousand dollars spent on labor.   "
},
{
  "id": "ex-linearization-root-exp-sin",
  "level": "2",
  "url": "sec-derivApp-ww.html#ex-linearization-root-exp-sin",
  "type": "Example",
  "number": "3.9.10",
  "title": "",
  "body": "  The equation   has a solution near . Approximate this solution by replacing the left-hand side with its linearization at and then solving the resulting equation.    Let   We approximate near using its linearization   First compute the value of the function at .   Next compute the derivative.   Evaluate the derivative at .   Therefore the linearization of at is   We now approximate the equation by solving     Thus an approximate solution to the equation is   If we have access to technology, we can check how good this approximation is by evaluating the original expression at . Doing so gives a value very close to , confirming that the linear approximation produced a reasonable estimate.  While this type of numerical check can be helpful for building intuition and verifying results, it is important to note that calculators may not be available on quizzes or exams. In those situations the goal is simply to use linearization to produce a reasonable approximation based on calculus rather than numerical computation.   "
},
{
  "id": "ex-linearization-battery-range",
  "level": "2",
  "url": "sec-derivApp-ww.html#ex-linearization-battery-range",
  "type": "Example",
  "number": "3.9.11",
  "title": "",
  "body": "  A phone’s battery range (in hours) depends on temperature (in degrees Fahrenheit). A test reports and .  (a) Estimate using the average rate of change from to .  (b) Write the linear approximation to near .  (c) Use your linear approximation to estimate .  (d) Interpret the meaning of in a sentence, including units.     Part (a) : Use the slope of the secant line from to as an estimate for :   So hours per degree Fahrenheit.   Part (b) : The linearization (tangent line approximation) at is   Using and our estimate , we get    Part (c) : Estimate by evaluating :   So the battery range at F is approximately hours.   Part (d) : The value hours per F means that near F, increasing the temperature by F decreases the battery range by about hours (about minutes).   "
},
{
  "id": "ex-critical-numbers-radical",
  "level": "2",
  "url": "sec-derivApp-ww.html#ex-critical-numbers-radical",
  "type": "Example",
  "number": "3.9.12",
  "title": "",
  "body": "  Find all critical numbers of the function     Recall that the critical numbers of a function are the values of in the domain of for which either or is undefined.  Rewrite the function using exponents:   Differentiate:   Finding a common denominator gives   To determine where , set the numerator equal to zero:    Next determine where the derivative is undefined by examining the denominator. The denominator is zero when    However, the original function is not defined at , so this value is not in the domain of and therefore cannot be a critical number.  Thus the only critical number of the function is    "
},
{
  "id": "ex-critical-numbers-rational",
  "level": "2",
  "url": "sec-derivApp-ww.html#ex-critical-numbers-rational",
  "type": "Example",
  "number": "3.9.13",
  "title": "",
  "body": "  Find all critical numbers of the function     Recall that the critical numbers of a function are the values of in the domain of for which either or is undefined.  We begin by computing the derivative using the quotient rule.   Factor the numerator.   To find where , we set the numerator equal to zero:      Next we determine where the derivative is undefined by examining the denominator. The denominator is zero when   However, for all real numbers , so the denominator can never be zero. Therefore is defined for all real .  Thus the critical numbers of are    "
...
{
  "id": "ex-absolute-extrema-graph",
  "level": "2",
  "url": "sec-derivApp-ww.html#ex-absolute-extrema-graph",
  "type": "Example",
  "number": "3.9.14",
  "title": "",
  "body": "  Consider the graph of below on the interval .   A graph of f(x) on a square grid from 0 to 5. Starting at (0,3), the function curves upward to a maximum at (1,4), then curves downward passing through (2,3) and reaching a minimum at (3,1). After x = 3, the graph is a straight line segment increasing to (5,5).    (a) Identify the critical numbers of and explain how you know they are critical numbers.  (b) Identify the absolute maximum and minimum values of and the -values where they occur.     Part (a) : The critical numbers of are the values of where the derivative is zero or undefined. From the graph, we can see that the function has a horizontal tangent at and a corner at . Therefore, the critical numbers of are    Part (b) : The absolute maximum value of on the interval is , which occurs at . The absolute minimum value of on the interval is , which occurs at .   "
},
{
  "id": "ex-absolute-extrema-polynomial",
  "level": "2",
  "url": "sec-derivApp-ww.html#ex-absolute-extrema-polynomial",
  "type": "Example",
  "number": "3.9.15",
  "title": "",
  "body": "  Consider the function   Determine the absolute maximum and minimum values of and the -values where these extrema occur.    First determine the critical numbers of . Compute the derivative.   Setting gives   Thus the critical numbers are   To determine the absolute extrema on the interval , we evaluate at the endpoints and at any critical numbers inside the interval. Since lies outside the interval, we only check , , and .   Comparing these values, the absolute maximum value of is which occurs at .  The absolute minimum value of is which occurs at .   "
},
{
  "id": "ex-absolute-extrema-abs",
  "level": "2",
  "url": "sec-derivApp-ww.html#ex-absolute-extrema-abs",
  "type": "Example",
  "number": "3.9.16",
  "title": "",
  "body": "  Consider the function   Determine the absolute maximum and minimum values of and the -values where these extrema occur.    When a function involves absolute values, it is often helpful to rewrite it using the definition of absolute value:   For this function,   Taking derivatives of each piece gives   The derivative at is undefined. Indeed,   and this limit does not exist. Thus the only critical number is   To determine the absolute extrema on the interval , evaluate at the critical number and the endpoints.   Therefore, the absolute maximum value of is , which occurs at . The absolute minimum value of is , which occurs at .   "
...
{
  "id": "ex-absolute-extrema-fractional-power",
  "level": "2",
  "url": "sec-derivApp-ww.html#ex-absolute-extrema-fractional-power",
  "type": "Example",
  "number": "3.9.17",
  "title": "",
  "body": "  Consider the function   Determine the absolute maximum and minimum values of and the -values where these extrema occur.    First determine the critical numbers of . Compute the derivative.   To determine where , solve   Multiply both sides by :     Next determine where the derivative is undefined. The derivative is undefined when    Thus the critical numbers are and . However, only lies in the interval .  To determine the absolute extrema on , evaluate at the endpoints and the critical number in the interval.   Comparing these values, the absolute maximum value of is , which occurs at . The absolute minimum value of is , which occurs at .   "
...
{
  "id": "ex-rolles-theorem-cubic",
  "level": "2",
  "url": "sec-derivApp-ww.html#ex-rolles-theorem-cubic",
  "type": "Example",
  "number": "3.9.18",
  "title": "",
  "body": "  Show that the function   on the interval satisfies the conditions of Rolle’s Theorem. Then find a value for which .    The function is a polynomial, so it is continuous for all real numbers and differentiable for all real numbers. Therefore it is continuous on the closed interval and differentiable on the open interval .  Next evaluate the function at the endpoints.   Since , all of the conditions of Rolle’s Theorem are satisfied. Therefore there must exist at least one such that   To find such a value, compute the derivative.   Now solve .     Of these solutions, only   lies in the interval . Therefore this value satisfies the conclusion of Rolle's Theorem.   "
},
{
  "id": "ex-mvt-cubic",
  "level": "2",
  "url": "sec-derivApp-ww.html#ex-mvt-cubic",
  "type": "Example",
  "number": "3.9.19",
  "title": "",
  "body": "  Consider the function   Verify that the Mean Value Theorem applies, and find a value for which     The function is a polynomial, so it is continuous for all real numbers and differentiable for all real numbers. Therefore it is continuous on the closed interval and differentiable on the open interval . Thus the conditions of the Mean Value Theorem are satisfied.  First compute the average rate of change of on .   Next compute the derivative of .   To find , solve      Since must lie in the interval , we discard the negative solution. Therefore   This value lies in the interval , so it satisfies the conclusion of the Mean Value Theorem.   "
},
{
  "id": "ex-mvt-rational",
  "level": "2",
  "url": "sec-derivApp-ww.html#ex-mvt-rational",
  "type": "Example",
  "number": "3.9.20",
  "title": "",
  "body": "  Consider the function   Verify that the Mean Value Theorem applies, and find a value for which     The function is a rational function, so it is differentiable wherever the denominator is nonzero. Since for all , the function is continuous on the closed interval and differentiable on the open interval . Therefore the conditions of the Mean Value Theorem are satisfied.  First compute the average rate of change of on the interval.   Next compute the derivative of .   To find , solve       Since must lie in the interval , we discard the negative solution. Therefore   Since , this value satisfies the conclusion of the Mean Value Theorem.   "
},
{
  "id": "ex-abs-value-analysis",
  "level": "2",
  "url": "sec-derivApp-ww.html#ex-abs-value-analysis",
  "type": "Example",
  "number": "3.9.21",
  "title": "",
  "body": "  Let .  (a) Find the critical number(s) of .  (b) Determine the intervals where is increasing and decreasing.  (c) Find the local maxima and minima of .    (a) First rewrite the absolute value as a piecewise function.   The domain of is all real numbers.  The derivative on each interval is   The derivative does not exist at , so this is a critical number.  (b) Since for and for , the function increases on the interval and decreases on the interval .  (c) By the First Derivative Test, since changes from positive to negative at , the function has a local maximum at . There are no local minima.   "
},
{
  "id": "ex-increasing-decreasing-cos2x",
  "level": "2",
  "url": "sec-derivApp-ww.html#ex-increasing-decreasing-cos2x",
  "type": "Example",
  "number": "3.9.22",
  "title": "",
  "body": "  Consider on the interval .  (a) Find the critical number(s) of .  (b) Determine the intervals where is increasing and decreasing.  (c) Find the local maxima and minima of .    (a) To find the critical numbers, compute the derivative.   This is always defined, so the only critical numbers will come from , solve   Of these solutions, only and lie in the interval , so these are the critical numbers.  (b) To determine where the function is increasing and decreasing, we can use the critical numbers to divide the interval into three subintervals: , , and . We can test a point in each interval to determine the sign of the derivative.  For , , so the function is increasing on .  For , , so the function is decreasing on .  For , , so the function is increasing on .  (c) By the First Derivative Test, since changes from positive to negative at , the function has a local maximum at . Since changes from negative to positive at , the function has a local minimum at .   "
},
{
  "id": "ex-curve-sketching-exp",
  "level": "2",
  "url": "sec-derivApp-ww.html#ex-curve-sketching-exp",
  "type": "Example",
  "number": "3.9.23",
  "title": "",
  "body": "  Consider the function .  (a) Find the critical number(s) of .  (b) Determine the intervals where is increasing and decreasing.  (c) Find the local maxima and minima of .  (d) Determine the intervals where is concave up and concave down, and find any inflection points.  (e) Sketch the graph of using the information from parts (a)-(d).    (a) To find the critical numbers, compute the derivative.   This is always defined, so the only critical numbers will come from , solve   Thus the only critical number is .  (b) To determine where the function is increasing and decreasing, we can use the critical number to divide the interval into two subintervals: and . We can test a point in each interval to determine the sign of the derivative.  For , , so the function is increasing on .  For , , so the function is decreasing on .  (c) By the First Derivative Test, since changes from positive to negative at , the function has a local maximum at . There are no local minima.  (d) To determine where the function is concave up and concave down, compute the second derivative.   This is always defined, so the only points of inflection will come from , solve   To determine the concavity, we can divide the interval into two subintervals: and . We can test a point in each interval to determine the sign of the second derivative.  For , , so the function is concave down on .  For , , so the function is concave up on .  Thus the function is concave down on and concave up on , and there is an inflection point at .  (e) To sketch the graph of , we can use the information from parts (a)-(d).   , so the graph passes through the point .  The function is increasing on and decreasing on .  There is a local maximum at .  The function is concave down on and concave up on .  There is an inflection point at .    Combining all this we can sketch the graph of .   A graph of f(x)=xe^(-x). The graph starts at (0,0), increases to a local maximum at x=1, then decreases and has an inflection point at x=2, after which it continues to decrease but is concave up.    "
},
{
  "id": "ex-curve-sketch-cubic-01",
  "level": "2",
  "url": "sec-derivApp-ww.html#ex-curve-sketch-cubic-01",
  "type": "Example",
  "number": "3.9.24",
  "title": "",
  "body": "  Let .  Analyze the function by determining the following.    Domain of .    Any vertical or horizontal asymptotes.    Whether is even, odd, or neither.    Intervals where is increasing and decreasing.    All critical points and classify them as local maxima, local minima, or neither.    Intervals of concavity and any inflection points.    Use the information above to sketch the graph of .      (a) The function is a polynomial, so it is defined for all real numbers. Thus the domain is .  (b) Since the function is defined for all real numbers, there are no vertical asymptotes. To find horizontal asymptotes, we can compute the limits as .   Thus there are no horizontal asymptotes.  (c) To determine symmetry, we can check whether or .   Since and , the function is neither even nor odd.  (d) To determine where the function is increasing and decreasing, we can compute the derivative and find the critical points.   The derivative is defined for all real numbers, and to find where the derivative is zero, we can solve   Thus the critical points are and .  To determine where the function is increasing and decreasing, we can use the critical points to divide the interval into three subintervals: , , and . We can test a point in each interval to determine the sign of the derivative.  For , , so the function is decreasing on .  For , , so the function is increasing on .  For , , so the function is decreasing on .  (e) By the First Derivative Test, since changes from negative to positive at , the function has a local minimum at . Since changes from positive to negative at , the function has a local maximum at .  (f) To determine where the function is concave up and concave down, compute the second derivative.   This is defined for all real numbers, so the only points of inflection will come from , solve   So the only point of inflection is at .  To determine the concavity, we can divide the interval into two subintervals: and . We can test a point in each interval to determine the sign of the second derivative.  For , , so the function is concave up on .  For , , so the function is concave down on .  Thus the function is concave up on and concave down on , and there is an inflection point at .  (g) To sketch the graph of , we can use the information from parts (a)-(f).   , so the graph passes through the point .  There is no symmetry or asymptotes.  The function is decreasing on , increasing on , and decreasing on .  There is a local minimum at and a local maximum at .  The function is concave up on and concave down on .  There is an inflection point at .    Combining all this we can sketch the graph of .   A graph of f(x)=-2x^3+24x-5. The graph has a local minimum at x=-2, a local maximum at x=2, and an inflection point at x=0. The graph is concave up on (-infinity,0) and concave down on (0,infinity).    "
},
{
  "id": "ex-curve-sketch-x13-xminus3",
  "level": "2",
  "url": "sec-derivApp-ww.html#ex-curve-sketch-x13-xminus3",
  "type": "Example",
  "number": "3.9.25",
  "title": "",
  "body": "  Let .    Determine the domain of .    Determine any vertical or horizontal asymptotes.    Determine whether has any symmetry (even\/odd\/neither).    Determine the intervals where is increasing and decreasing.    Find and classify all critical points (local maxima, local minima, or neither).    Determine the intervals where is concave up and concave down, and identify any inflection points.    Use the information above to sketch the graph of .      (a) The function is defined for all real numbers, so the domain is .  (b) There are no vertical asymptotes since the function is defined for all real numbers. To find horizontal asymptotes, we can compute the limits as .   Thus there are no horizontal asymptotes.  (c) To determine symmetry, we can check whether or .   Since and , the function is neither even nor odd.  (d) To determine where the function is increasing and decreasing, we can compute the derivative and find the critical points.   The derivative is undefined at , and to find where the derivative is zero, we can solve   Thus the critical points are and .  To determine where the function is increasing and decreasing, we can use the critical points to divide the interval into three subintervals: , , and . We can test a point in each interval to determine the sign of the derivative.   For , , so the function is decreasing on .  For , , so the function is decreasing on .  For , , so the function is increasing on .   Therefore the function is decreasing on and , and increasing on .  (e) To find and classify the critical points, we can use the First Derivative Test.  At , the derivative changes from negative to negative, so there is neither a local maximum nor a local minimum at .  At , the derivative changes from negative to positive, so there is a local minimum at .  Thus there is a local minimum at .  (f) To determine where the function is concave up and concave down, we can compute the second derivative and find the inflection points.   The second derivative is undefined at , and to find where the second derivative is zero, we can solve   Thus the possible points of inflection are and but we need to check if they change concavity by testing the sign of the second derivative in each interval.  To determine the concavity of the function, we can use the possible points of inflection to divide the interval into three subintervals: , , and . We can test a point in each interval to determine the sign of the second derivative.   For , , so the function is concave up on .  For , , so the function is concave down on .  For , , so the function is concave up on .   Therefore the function is concave up on and , and concave down on . There are inflection points at and .  (g) To sketch the graph of , we can use the information from parts (a)-(f).  The domain is all real numbers.  There are no asymptotes.  The function is neither even nor odd.  The function is decreasing on and , and increasing on .  There is a local minimum at .  The function is concave up on and , and concave down on . There are inflection points at and .    Combining all this we can sketch the graph of .   A graph of f(x)=x^(1\/3)(x-3). The graph decreases and is concave up on (-infinity, -3\/2), continues to decrease but is now concave down on (-3\/2, 0), continues to decrease and is concave up on (0, 3\/4), then increases and is concave up on (3\/4, infinity). There is a local minimum at x=3\/4, and inflection points at x=-3\/2 and x=0.    "
},
{
  "id": "ex-optimization-triangle-axes",
  "level": "2",
  "url": "sec-derivApp-ww.html#ex-optimization-triangle-axes",
  "type": "Example",
  "number": "3.9.26",
  "title": "Maximizing the Area of a Triangle Formed with the Axes.",
  "body": " Maximizing the Area of a Triangle Formed with the Axes   Find the point on the curve in the first quadrant that forms a triangle with the coordinate axes having the largest possible area.   A graph of the curve y=6-x^2. A point (x,y) on the curve forms a triangle with the x axis, and we want to find the point that maximizes the area of this triangle.      Let be a point on the curve in the first quadrant. This point, together with the coordinate axes, forms a right triangle with vertices and .  The base of the triangle is and the height is , so the area is   Since the point lies on the curve , we substitute to write the area as a function of :   Simplifying,   Because the point lies in the first quadrant, we require and . From , we obtain   To find the maximum area, differentiate:   Set the derivative equal to zero:   Since we are in the first quadrant, we take the positive value .  Now find the corresponding -value:   Thus the point on the curve is .  To confirm this gives a maximum, compute the second derivative:   Since , the area function is concave down at this point, so the area is maximized there.  The maximum area is    "
},
{
  "id": "ex-opt-right-triangle-fixed-hypotenuse",
  "level": "2",
  "url": "sec-derivApp-ww.html#ex-opt-right-triangle-fixed-hypotenuse",
  "type": "Example",
  "number": "3.9.27",
  "title": "",
  "body": "  A ladder of length feet is leaning against a wall. The foot of the ladder is being pulled away from the wall, and we want to determine how to pull the ladder to maximize the area of the triangle formed by the ladder, the wall, and the ground.    Find an equation for the area of the triangle that only relies on the variable (the distance from the wall to the foot of the ladder).  What is the largest possible area of such a triangle, and what are the lengths of the legs when the area is maximized?      (a) Since the triangle is right, the legs and and the hypotenuse satisfy the Pythagorean Theorem:   Solving for , we get   The area of a right triangle is   Substituting gives   where .  (b) To maximize the area, we differentiate:   Using the product rule,   Simplifying,   Combine the terms into a single fraction:   Critical points occur when or when is undefined. On the interval , the denominator is positive, so we set the numerator equal to zero:      Since must be positive, we take .  To confirm this gives a maximum, we will use the Closed Interval Test. We will evaluate the area at the critical point and at the endpoints of the interval.   Thus the maximum area is square feet, and this occurs when . To find the corresponding value of , we can substitute into the Pythagorean Theorem:   Therefore the area is maximized when the legs of the triangle are both feet.   "
},
{
  "id": "ex-opt-box-no-top",
  "level": "2",
  "url": "sec-derivApp-ww.html#ex-opt-box-no-top",
  "type": "Example",
  "number": "3.9.28",
  "title": "",
  "body": "  A box with a square base and no top must have a volume of cubic inches.   A 3D rectangular box with a square base. The base edges are labeled x, and the vertical edge is labeled y, indicating the height of the box.      Write the surface area of the box as a function of the base side length .    Find the dimensions of the box that minimize the amount of material used.      (a) Let be the side length of the square base and be the height of the box. The volume is given by   Solving for , we obtain   Since the box has no top, the surface area consists of the base and four sides:   Substituting gives   Simplifying,   (b) To minimize the surface area, differentiate:   Set the derivative equal to zero:   Now find the height:   To show that the surface area is minimized at this critical point, we can compute the second derivative:   Plugin in gives .  So this critical point gives a minimum.  Therefore, the dimensions that minimize the amount of material used are    "
},
{
...
{
  "id": "ex-antiderivative-sketch",
  "level": "2",
  "url": "sec-integral-antiderivatives.html#ex-antiderivative-sketch",
  "type": "Example",
  "number": "4.1.15",
  "title": "",
  "body": "  The graph of is shown below. Sketch the graph of an antiderivative that satisfies .   A graph of a function made of connected line segments. The graph decreases from (0,2) to (2,-2), rises to (3,-1), stays flat from x=3 to x=4 at y=-1, and then increases to (6,1).      Before we sketch the graph of , let's think about what it should look like. Remember that by the definition of antiderivative, , so the slope of at any point is given by the value of at that point. And likewise , so the concavity of at any point is given by the slope of at that point.  From the graph of , we can see that:  On the interval , is positive, so is increasing. But is decreasing so the slope of is getting less positive, so is concave down.  On the interval , is negative, so is decreasing. In addition, continues to be decreasing, so the slope of is getting more negative, so is still concave down.  On the interval , is still negative, so is still decreasing. However, is increasing, so the slope of is getting less negative, so is concave up (because the switch in concavity we know there is an inflection point at ).  On the interval , has a constant value of , so is decreasing at a constant rate (like a line with slope ).  On the interval , is negative, so is decreasing. However, is increasing, so the slope of is getting less negative, so is concave up.  On the interval , is positive, so is increasing. In addition, continues to be increasing, so the slope of is getting more positive, so is still concave up.    We also know that , so we can start our sketch at the point (0,0). Then we can use the information about where the function is increasing or decreasing to sketch the graph of .   A graph of a function made of connected curves. The graph starts at (0,0), increases and is concave down until x=1, then decreases and is concave down until x=2, then decreases and is concave up until x=3, then decreases at a constant rate until x=4, then decreases and is concave up until x=5, then increases and is concave up until x=6.   We cannot yet determine the specific heights of many of these points (so your sketch may look slightly different), but we can get a good qualitative picture of the graph of and know where it is increasing, decreasing, concave up, and concave down just from the graph of .   "
},
{
  "id": "ex-tf01",
  "level": "2",
...
},
{
  ...
  "body": " The Definite Integral     Understand the definition of the definite integral as the limit of Riemann sums.    Correctly interpret the notation , including the meaning of the integrand, limits of integration, and variable of integration.    Explain the geometric interpretation of the definite integral as signed area (or net area), recognizing that regions above the -axis contribute positive area and regions below the -axis contribute negative area.    Evaluate definite integrals that correspond to simple geometric regions such as rectangles, triangles, or circles by using formulas from geometry.    Use definite integral notation and its properties to compute unknown integrals from known ones.    Use comparison and bounds properties to estimate or bound the value of a definite integral.     In our last section we used Riemann sums to try to approximate the area under a curve (or more generally, the total change of a quantity). As we took more and more terms, the approximation got better and better. In this section we will give a precise definition of the limit of Riemann sums, to create a mathematical tool used to measure this value exactly. This tool is called the definite integral .  Throughout this section, it is helpful to keep both interpretations in mind. Sometimes will represent a geometric quantity such as area, and sometimes it will represent the total accumulation of a changing quantity. These two viewpoints are closely connected: the geometry helps us visualize the integral, while the accumulation viewpoint helps us interpret what the integral means in applications.   The Definition of the Definite Integral    Let be a function and let . For any positive integer , divide the interval into subintervals of equal width . In each subinterval, choose a sample point .  Then we define the definite integral of from to as:   If this limit exists then we say that is integrable on .         The notation is read as “the integral of from to with respect to .”     is the integral sign,     is the lower limit of integration,     is the upper limit of integration,     is the integrand,     is the variable of integration.     The variable of integration is just a name, so changing it does not change the value:     Visually, we are taking the limit of the sum of the areas of many very thin rectangles (remember ), which approximates the area under the graph of on the interval .  But it is also useful to think of each term as a small amount of accumulation : a rate or density multiplied by a small width . Adding these little pieces together gives the total accumulated change over the interval. So even though the picture is geometric, the definite integral is not only about area.   The area under the graph of on is approximated by the sum of the areas of many thin rectangles. As we take more and more rectangles, the approximation gets better and better. The definite integral is defined as the limit of these sums as the rectangles get thinner and thinner.   Animated graph showing the function f(x) = x^2 on the interval [0,2] with rectangles approximating the area under the curve. As the number of rectangles increases, they become thinner and the approximation of the area under the curve becomes more accurate. The animation illustrates how the Riemann sum approaches the value of the definite integral as n approaches infinity.     Interpreting the Definition  While this limiting process provides a precise definition of the definite integral, it is not very convenient for actually computing values by hand. Determining the exact value of the limit of many increasingly thin rectangles is typically something that requires a computer or calculator.  Because of this, we will not usually use this definition to compute the true area under a curve or the total accumulation of a quantity. Instead, in the next section we will develop a powerful result called the Fundamental Theorem of Calculus , which provides a far more efficient way to evaluate definite integrals.   There are a few special cases we can handle already. If the region described by the integral corresponds to a familiar geometric shape such as a rectangle, triangle, or part of a circle. In those cases we can compute the value of the integral using basic formulas from geometry.  In this section we will largely focus on interpreting definite integral notation and learning some of the fundamental properties that definite integrals satisfy.    Signed Area  In the last section we required that so that the integral would represent the area under the curve. However in this section we will allow to take on negative values as well. Therefore the definite integral will not always represent area in the usual sense, but it will still have a geometric interpretation as a type of area, called signed area (or net area ).  From the accumulation point of view, negative values of are not strange at all. If represents a rate of change, then a negative value simply means the quantity is decreasing rather than increasing. In that setting, a negative definite integral represents a negative net accumulation, or equivalently, an overall decrease over the interval.  We think of each term as (height) (width). When the graph lies below the -axis, the \" height \" is negative, so it contributes negative area.   If the graph of lies above the -axis, the integral contributes positive area.  If the graph lies below the -axis, the integral contributes negative area.     The graph of on the interval is shown below, with several signed areas indicated. Use these areas to evaluate .   Graph of a function f(x) with areas under the curve shaded in green and areas above the curve shaded in red. The area under the curve from x=0 to x=3 is labeled \"Area = 5\" and is shaded green, indicating it contributes positive area. The area above the curve from x=3 to x=8 is labeled \"Area = -12\" and is shaded red, indicating it contributes negative area. The function f(x) is also labeled on the graph.      The graph first contributes positive signed area, then it dips below the -axis and contributes negative signed area. So the integral measures the net result after these contributions are combined. From an accumulation point of view, this means the negative contribution outweighs the positive contribution overall. Therefore       Definite Integrals from Geometry  Sometimes the region described by a definite integral corresponds to a simple geometric shape. In those cases we can compute the integral exactly using formulas from geometry. Even when we use geometry, however, the answer can still be interpreted as a total accumulation. The geometry gives us a convenient way to compute the value, while the integral itself may still represent a net change in some applied quantity.    Evaluate by interpreting it as a geometric area.    The graph of is a horizontal line. The region between the graph and the -axis from to forms a rectangle.   Therefore       Evaluate     Let's quickly sketch the graph of to understand the region described by the integral.   Graph of the function f(x) = 2 - x, which is a straight line with a negative slope. The line intersects the y-axis at (0, 2) and the x-axis at (2, 0). The area under the curve from x=1 to x=2 forms a triangle above the x-axis, while the area from x=2 to x=5 forms a triangle below the x-axis.    Notice that the graph forms a triangle above the -axis on the interval and a triangle below the -axis on the interval . Therefore:  The positive part represents accumulation in one direction, while the negative part represents accumulation in the opposite direction. Since the negative portion is larger in magnitude, the overall accumulation on will be negative.       Properties of Definite Integrals  Definite integrals satisfy several useful algebraic and comparison properties. These allow us to break complicated integrals into simpler ones and to estimate their values using bounds on the function.   Basic Properties of Definite Integrals   Suppose and are integrable on and is a constant. Then the following properties hold.     Sum:  .     Difference:  .     Constant Multiple:  .     Domination: If for all in , then .     Bounds: If for all in , then      Splitting an Interval: If , then       Two additional conventions are useful when working with definite integrals.  If the limits of integration are the same, then every Riemann sum has width . Therefore .  If the limits are reversed, we define . This convention keeps many formulas simple and makes the splitting rule work cleanly even when the limits appear in different orders.  All of these properties are consistent with interpreting the definite integral both as signed area and as total accumulation. Geometrically, areas over adjacent intervals add together. From an accumulation point of view, the total change over a larger interval is the sum of the changes over its pieces, multiplying a function by a constant scales the accumulation, and larger functions produce larger total accumulation.  Now let's see what sort of problems we can solve using these properties.    Suppose and . Use the properties of integrals to find the following values.  (a)  (b)    (a) By the sum rule,   (b) By the difference and constant multiple rules,       Suppose for all in . Use the properties of integrals to find bounds for .    Since for all in , we can apply the bounds rule.   So we have found that is trapped between 6 and 15.      Suppose and . Use the properties of integrals to find .    We can use the splitting rule to write Substituting the known values, Solving for the unknown integral,       Additional Worked-Out Examples  To keep this section at a reasonable length, we include only a few representative examples directly in the text. If you find yourself stuck on a homework problem, or if you are studying before a quiz or exam, additional fully worked-out examples are available via:  Additional Worked-Out Problems for Definite Integrals      Practice \/ Study Problems   Some True\/False Problems   Determine whether each statement is true or false and briefly justify your reasoning.     Computing a definite integral directly from its definition usually requires evaluating a limit of many rectangle area approximations.    True . The definition of the definite integral is the limit of Riemann sums, which are sums of areas of rectangles.       .     True . Sketching on the interval , we see that the region described by the integral forms a trapezoid (a combination of a rectangle and a triangle). The base has width of . For the rectangle portion the height is so the rectangle has an area of .  For the triangle portion the height is , so the triangle has an area of . Therefore the total area is .  Since the graph of lies above the -axis on the interval , the integral contributes positive area. Therefore:       If and , then .     True . By the sum rule for integrals,       If for all , then .     True . By the domination rule for integrals, if for all , then       If and , then .     True . By the splitting rule for integrals, since , then       If , then .     True . By the convention for reversed limits of integration, we have        .     False . To solve this it first helps to realize that is the top half of a circle of radius 2.  The region described by the integral is a semicircle of radius 2, so the area is half the area of a circle of radius 2:      If for all in , then .     True . By the bounds rule for integrals, since for all in , then       If is integrable on , then the definite integral must always be positive.    False . The definite integral can be negative if the graph of lies below the -axis on the interval , since then the integral contributes negative signed area. From an accumulation point of view, this corresponds to a negative net change, or an overall decrease, over the interval.      If is negative on , then is negative.     True . If is negative on , then the graph of lies below the -axis on the interval . Therefore the integral contributes negative signed area, so is negative. In an application where represents a rate of change, this would mean the total accumulation is negative, so the quantity decreases overall.      If , then the graph of must lie entirely below the -axis on .     False . The definite integral can be negative even it is not the case that is negative on the entire interval. For example, look back at       If , and is continuous then the graph of must intersect the -axis somewhere in the interval .     True . If , then the total signed area under the graph of on the interval is zero. If for instance, on the entire interval then . And similarly it cannot be exclusively negative.      "
},
{
  ...
  "number": "4.3",
  "title": "",
  "body": "   Understand the definition of the definite integral as the limit of Riemann sums.    Correctly interpret the notation , including the meaning of the integrand, limits of integration, and variable of integration.    Explain the geometric interpretation of the definite integral as signed area (or net area), recognizing that regions above the -axis contribute positive area and regions below the -axis contribute negative area.    Evaluate definite integrals that correspond to simple geometric regions such as rectangles, triangles, or circles by using formulas from geometry.    Use definite integral notation and its properties to compute unknown integrals from known ones.    Use comparison and bounds properties to estimate or bound the value of a definite integral.    "
},
{
  "id": "sec-integral-defInt-3",
  "level": "2",
  "url": "sec-integral-defInt.html#sec-integral-defInt-3",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "sec-integral-defInt.html#def-definite-integral",
  "type": "Definition",
  "number": "4.3.1",
  "title": "",
  "body": "  Let be a function and let . For any positive integer , divide the interval into subintervals of equal width . In each subinterval, choose a sample point .  Then we define the definite integral of from to as:   If this limit exists then we say that is integrable on .   "
},
{
  "id": "note-definite-integral-notation",
  "level": "2",
  "url": "sec-integral-defInt.html#note-definite-integral-notation",
  "type": "Note",
  "number": "4.3.2",
  "title": "",
  "body": "     The notation is read as “the integral of from to with respect to .”     is the integral sign,     is the lower limit of integration,     is the upper limit of integration,     is the integrand,     is the variable of integration.     The variable of integration is just a name, so changing it does not change the value:    "
},
{
  "id": "ssec-definite-integral-definition-6",
  "level": "2",
  "url": "sec-integral-defInt.html#ssec-definite-integral-definition-6",
  "type": "Figure",
  "number": "4.3.3",
  "title": "",
  "body": " The area under the graph of on is approximated by the sum of the areas of many thin rectangles. As we take more and more rectangles, the approximation gets better and better. The definite integral is defined as the limit of these sums as the rectangles get thinner and thinner.   Animated graph showing the function f(x) = x^2 on the interval [0,2] with rectangles approximating the area under the curve. As the number of rectangles increases, they become thinner and the approximation of the area under the curve becomes more accurate. The animation illustrates how the Riemann sum approaches the value of the definite integral as n approaches infinity.   "
},
{
  "id": "remark-interpreting-definite-integral",
  "level": "2",
  "url": "sec-integral-defInt.html#remark-interpreting-definite-integral",
  "type": "Remark",
  "number": "4.3.4",
  "title": "Interpreting the Definition.",
  "body": " Interpreting the Definition  While this limiting process provides a precise definition of the definite integral, it is not very convenient for actually computing values by hand. Determining the exact value of the limit of many increasingly thin rectangles is typically something that requires a computer or calculator.  Because of this, we will not usually use this definition to compute the true area under a curve or the total accumulation of a quantity. Instead, in the next section we will develop a powerful result called the Fundamental Theorem of Calculus , which provides a far more efficient way to evaluate definite integrals.  "
},
{
  "id": "ssec-signed-area-2",
  "level": "2",
  "url": "sec-integral-defInt.html#ssec-signed-area-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "signed area net area "
},
{
  "id": "ex-integral-signed-area",
  "level": "2",
  "url": "sec-integral-defInt.html#ex-integral-signed-area",
  "type": "Example",
  "number": "4.3.5",
  "title": "",
  "body": "  The graph of on the interval is shown below, with several signed areas indicated. Use these areas to evaluate .   Graph of a function f(x) with areas under the curve shaded in green and areas above the curve shaded in red. The area under the curve from x=0 to x=3 is labeled \"Area = 5\" and is shaded green, indicating it contributes positive area. The area above the curve from x=3 to x=8 is labeled \"Area = -12\" and is shaded red, indicating it contributes negative area. The function f(x) is also labeled on the graph.      The graph first contributes positive signed area, then it dips below the -axis and contributes negative signed area. So the integral measures the net result after these contributions are combined. From an accumulation point of view, this means the negative contribution outweighs the positive contribution overall. Therefore    "
},
{
  "id": "ex-integral-rectangle",
  "level": "2",
  "url": "sec-integral-defInt.html#ex-integral-rectangle",
  "type": "Example",
  "number": "4.3.6",
  "title": "",
  "body": "  Evaluate by interpreting it as a geometric area.    The graph of is a horizontal line. The region between the graph and the -axis from to forms a rectangle.   Therefore    "
},
{
  "id": "ex-integral-triangle",
  "level": "2",
  "url": "sec-integral-defInt.html#ex-integral-triangle",
  "type": "Example",
  "number": "4.3.7",
  "title": "",
  "body": "  Evaluate     Let's quickly sketch the graph of to understand the region described by the integral.   Graph of the function f(x) = 2 - x, which is a straight line with a negative slope. The line intersects the y-axis at (0, 2) and the x-axis at (2, 0). The area under the curve from x=1 to x=2 forms a triangle above the x-axis, while the area from x=2 to x=5 forms a triangle below the x-axis.    Notice that the graph forms a triangle above the -axis on the interval and a triangle below the -axis on the interval . Therefore:  The positive part represents accumulation in one direction, while the negative part represents accumulation in the opposite direction. Since the negative portion is larger in magnitude, the overall accumulation on will be negative.    "
},
{
  "id": "thm-definite-integral-properties",
  "level": "2",
  "url": "sec-integral-defInt.html#thm-definite-integral-properties",
  "type": "Theorem",
  "number": "4.3.8",
  "title": "Basic Properties of Definite Integrals.",
  "body": " Basic Properties of Definite Integrals   Suppose and are integrable on and is a constant. Then the following properties hold.     Sum:  .     Difference:  .     Constant Multiple:  .     Domination: If for all in , then .     Bounds: If for all in , then      Splitting an Interval: If , then      "
},
{
  "id": "ex-integral-properties1",
  "level": "2",
  "url": "sec-integral-defInt.html#ex-integral-properties1",
  "type": "Example",
  "number": "4.3.9",
  "title": "",
  "body": "  Suppose and . Use the properties of integrals to find the following values.  (a)  (b)    (a) By the sum rule,   (b) By the difference and constant multiple rules,    "
},
{
  "id": "ex-integral-properties2",
  "level": "2",
  "url": "sec-integral-defInt.html#ex-integral-properties2",
  "type": "Example",
  "number": "4.3.10",
  "title": "",
  "body": "  Suppose for all in . Use the properties of integrals to find bounds for .    Since for all in , we can apply the bounds rule.   So we have found that is trapped between 6 and 15.   "
},
{
  "id": "ex-integral-properties3",
  "level": "2",
  "url": "sec-integral-defInt.html#ex-integral-properties3",
  "type": "Example",
  "number": "4.3.11",
  "title": "",
  "body": "  Suppose and . Use the properties of integrals to find .    We can use the splitting rule to write Substituting the known values, Solving for the unknown integral,    "
},
{
  "id": "exercise-definite-integral-true-false1",
  "level": "2",
  "url": "sec-integral-defInt.html#exercise-definite-integral-true-false1",
  "type": "Exercise",
  "number": "1",
  "title": "",
  "body": "  Computing a definite integral directly from its definition usually requires evaluating a limit of many rectangle area approximations.    True . The definition of the definite integral is the limit of Riemann sums, which are sums of areas of rectangles.   "
},
{
  "id": "exercise-definite-integral-true-false2",
  "level": "2",
  "url": "sec-integral-defInt.html#exercise-definite-integral-true-false2",
  "type": "Exercise",
  "number": "2",
  "title": "",
  "body": "   .     True . Sketching on the interval , we see that the region described by the integral forms a trapezoid (a combination of a rectangle and a triangle). The base has width of . For the rectangle portion the height is so the rectangle has an area of .  For the triangle portion the height is , so the triangle has an area of . Therefore the total area is .  Since the graph of lies above the -axis on the interval , the integral contributes positive area. Therefore:    "
},
{
  "id": "exercise-definite-integral-true-false3",
  "level": "2",
  "url": "sec-integral-defInt.html#exercise-definite-integral-true-false3",
  "type": "Exercise",
  "number": "3",
  "title": "",
  "body": "  If and , then .     True . By the sum rule for integrals,    "
},
{
  "id": "exercise-definite-integral-true-false4",
  "level": "2",
  "url": "sec-integral-defInt.html#exercise-definite-integral-true-false4",
  "type": "Exercise",
  "number": "4",
  "title": "",
  "body": "  If for all , then .     True . By the domination rule for integrals, if for all , then    "
},
{
  "id": "exercise-definite-integral-true-false5",
  "level": "2",
  "url": "sec-integral-defInt.html#exercise-definite-integral-true-false5",
  "type": "Exercise",
  "number": "5",
  "title": "",
  "body": "  If and , then .     True . By the splitting rule for integrals, since , then    "
},
{
  "id": "exercise-definite-integral-true-false6",
  "level": "2",
  "url": "sec-integral-defInt.html#exercise-definite-integral-true-false6",
  "type": "Exercise",
  "number": "6",
  "title": "",
  "body": "  If , then .     True . By the convention for reversed limits of integration, we have    "
},
{
  "id": "exercise-definite-integral-true-false7",
  "level": "2",
  "url": "sec-integral-defInt.html#exercise-definite-integral-true-false7",
  "type": "Exercise",
  "number": "7",
  "title": "",
  "body": "   .     False . To solve this it first helps to realize that is the top half of a circle of radius 2.  The region described by the integral is a semicircle of radius 2, so the area is half the area of a circle of radius 2:    "
},
{
  "id": "exercise-definite-integral-true-false8",
  "level": "2",
  "url": "sec-integral-defInt.html#exercise-definite-integral-true-false8",
  "type": "Exercise",
  "number": "8",
  "title": "",
  "body": " If for all in , then .     True . By the bounds rule for integrals, since for all in , then    "
},
{
  "id": "exercise-definite-integral-true-false9",
  "level": "2",
  "url": "sec-integral-defInt.html#exercise-definite-integral-true-false9",
  "type": "Exercise",
  "number": "9",
  "title": "",
  "body": "  If is integrable on , then the definite integral must always be positive.    False . The definite integral can be negative if the graph of lies below the -axis on the interval , since then the integral contributes negative signed area. From an accumulation point of view, this corresponds to a negative net change, or an overall decrease, over the interval.   "
},
{
  "id": "exercise-definite-integral-true-false10",
  "level": "2",
  "url": "sec-integral-defInt.html#exercise-definite-integral-true-false10",
  "type": "Exercise",
  "number": "10",
  "title": "",
  "body": "  If is negative on , then is negative.     True . If is negative on , then the graph of lies below the -axis on the interval . Therefore the integral contributes negative signed area, so is negative. In an application where represents a rate of change, this would mean the total accumulation is negative, so the quantity decreases overall.   "
},
{
  "id": "exercise-definite-integral-true-false11",
  "level": "2",
  "url": "sec-integral-defInt.html#exercise-definite-integral-true-false11",
  "type": "Exercise",
  "number": "11",
  "title": "",
  "body": "  If , then the graph of must lie entirely below the -axis on .     False . The definite integral can be negative even it is not the case that is negative on the entire interval. For example, look back at    "
},
{
  "id": "exercise-definite-integral-true-false12",
  "level": "2",
  "url": "sec-integral-defInt.html#exercise-definite-integral-true-false12",
  "type": "Exercise",
  "number": "12",
  "title": "",
  "body": "  If , and is continuous then the graph of must intersect the -axis somewhere in the interval .     True . If , then the total signed area under the graph of on the interval is zero. If for instance, on the entire interval then . And similarly it cannot be exclusively negative.   "
},
{
  "id": "sec-integral-FTC",
  "level": "1",
  ...
  "body": " The Fundamental Theorem of Calculus    State and apply the First Fundamental Theorem of Calculus to compute derivatives of functions defined by integrals.  Interpret accumulation functions as total accumulated (signed) change from to and recognize them as antiderivatives.  Use the relationship to analyze accumulation functions, including determining where they are increasing, decreasing, concave up, and concave down.  State and apply the Second Fundamental Theorem of Calculus to evaluate definite integrals using antiderivatives.     Introduction to the Integral as an Antiderivative  In the previous section we used a velocity function to compute the change in position (displacement) over a time interval . The distance is an integral defined as a limit of Riemann sums, adding up (velocity) (time) over many small time increments:   If we fix the starting time and assume , then taking a variable endpoint gives a function   Since the rate of change of position is velocity, . The remarkable point is that the integral function always produces an antiderivative of , even if we cannot find an antiderivative by reversing derivative formulas.    The First Fundamental Theorem of Calculus   First Fundamental Theorem of Calculus   Let be continuous on and define   Then for . In particular, is the unique antiderivative of satisfying .    Idea of a Proof  We start from the definition of the derivative: Using the splitting rule for integrals, So we have:   Here is a sketch of the graph of to illustrate the idea:   Graph of a continuous function f with a small interval [x, x+h] highlighted. The area under the curve of f from x to x+h is shaded in blue, representing the integral \\int_x^{x+h} f(t) dt. As h approaches 0, this area approximates a rectangle with height f(x) and width h, leading to the conclusion that the limit of (1\/h) times this area equals f(x).    Geometrically, the integral is the area under the curve of from to (shaded in blue above). When is small, this area is approximately a rectangle with width and height (the hatched rectangle in the image above). So therefore   As , the approximation becomes exact, so .  For those worried that this is not a rigorous proof, please see the \"Finer Details of the Proof\" below.    Finer Details of the Proof  In the proof idea, we used the approximation that when is small. But how do we know that the limit of the approximation is correct?  To control the errors, let's take the absolute minimum value and absolte maximum value of the continuous function on the closed interval (we can do this by the Extreme Value Theorem). To indicate that these values depend on , we write and . Therefore So the bounds rules for definite integrals give   As , the interval shrinks to the point , so by continuity By the squeeze theorem, , hence .  The condition and the antiderivative uniqueness theorem give the uniqueness statement.     In physical language: the rate of change of a cumulative effect up to time is the strength of the effect at time .    The First Fundamental Theorem can be used as a basic derivative rule: if is continuous, then   Here is a constant, is the input, and is a dummy variable that only matters inside the integral.     Find the derivative of .    By the First Fundamental Theorem, .  Note that we never needed to evaluate the integral or find an explicit formula for . The First Fundamental Theorem allows us to find the derivative without needing an explicit formula for .      Accumulation Functions  The First Fundamental Theorem of Calculus tells us that integrals with a variable upper limit naturally produce antiderivatives. Because of this, functions of the form   appear frequently in calculus. Such functions are called accumulation functions because they measure the total accumulated change of the quantity from up to .  As we found in our last section, the value of represents the signed area between the graph of and the -axis from to . Areas above the axis contribute positively, while areas below the axis contribute negatively.  Let's get some more practice with accumulation functions and their relationship to the original function.    Suppose the graph of is shown below. And let     A graph of on the interval shown on a grid with spacing in both the horizontal and vertical directions. The signed areas between the curve and the -axis are labeled.   Graph of a function g(t) on a grid with unit spacing. The curve passes through the points (1,0), (2,-2), (3,0), and (4,4). The region above the axis from the left endpoint to t=1 has labeled area 0.3. The region below the axis from t=1 to t=3 has labeled area -2.5. The region above the axis from t=3 to t=4 has labeled area 2.3. A dashed vertical line at t=4 marks the endpoint of the accumulated area.      Use the graph to answer the following questions.  (a) Find .  (b) Find .  (c) On which intervals is increasing?  (d) On which intervals is decreasing?  (e) Where does have a local maximum?    (a) By the definition of , we have The integral from 3 to 4 is the area of the green shaded region, which is 2.3. So .  (b) By the First Fundamental Theorem, . From the graph, , so .  (c) The function is increasing where . From the graph, this happens on the intervals and .  (d) The function is decreasing where . From the graph, this happens on the interval .  (e) Local maxima of occur where changes from positive to negative. From the graph, this happens at , so has a local maximum at . We can also check the endpoints. Since for , is increasing on , so is a local minimum. Since for , is increasing on , so is a local maximum. Therefore the local maxima of are at and .    Thanks to the First Fundamental Theorem of Calculus, we can also do curve sketching style problems with accumulation functions.    Consider the function .  (a) Evaluate .  (b) Find where is increasing and where it is decreasing.  (c) Find where is concave up and where it is concave down.  (d) Use the information from parts (a)-(c) to find a rough sketch the graph of .     Part (a):   Since the lower and upper bound of the integral are the same.   Part (b):  By the First Fundamental Theorem, Since for all , the sign of is determined by the sign of . So when , and when . Therefore is increasing on and decreasing on .   Part (c)  To find where is concave up or down, we need to find the second derivative. We have Since for all , the sign of is determined by the sign of .  So when , and when . Therefore is concave up on and concave down on .   Part (d) We have the following information about the graph of :   , so the graph passes through the origin.   is increasing on and decreasing on , so the graph has a local maximum at .   is concave up on and concave down on , so the graph has an inflection point at .  Putting this all together, we get the following sketch of the graph of .  Graph of the accumulation function H(x). The graph passes through the origin, has a local maximum at x=1, and an inflection point at x=0. The graph is increasing and concave up for x less than 0, increasing and concave down for x between 0 and 1, and decreasing and concave down for x larger than 1.      Now let's move on to the second part of the Fundamental Theorem of Calculus, which allows us to evaluate definite integrals from an antiderivative (instead of having to take a limit of a Riemann sum).    The Second Fundamental Theorem of Calculus   Second Fundamental Theorem of Calculus   Suppose is an antiderivative of a continuous function on , so . Then   That is, the integral of a rate of change is the total change.    By the First Fundamental Theorem, is an antiderivative of . Any two antiderivatives differ by a constant, so . Since , we get , so . Thus , and evaluating at gives       Evaluate .    An antiderivative is . Apply the Second Fundamental Theorem of Calculus:    Another antiderivative is . See that you get the same answer if you use this antiderivative instead:   No matter the value of the constant, the difference will always be the same, so we get the same answer for the integral.      The Second Fundamental Theorem of Calculus allows us to evaluate a definite integral by finding an antiderivative. In practice, we often write the evaluation of the integral as   The notation is read as \"F of x evaluated from a to b\" and means . This is just a convenient shorthand for writing the difference of the antiderivative at the endpoints.     Determine the net area between and the -axis on the interval .    The net area is given by a definite integral   So the net area is .      Additional Worked-Out Examples  To keep this section at a reasonable length, we include only a few representative examples directly in the text. If you find yourself stuck on a homework problem, or if you are studying before a quiz or exam, additional fully worked-out examples are available via:  Additional Worked-Out Problems for The Fundamental Theorem of Calculus      Practice \/ Study Problems   Some True\/False Problems   Determine whether each statement is true or false and briefly justify your reasoning.     The notation means .    False. The notation means .           True. An antiderivative of is , so evaluating from to gives .           False. Using the Second Fundamental Theorem of Calculus, we can evaluate both integrals. The left integral evaluates to   The right integral evaluates to   Since we know we have , so .      The area between and the -axis on the interval is .     False. The area is given by the integral . An antiderivative of is , so evaluating from 0 to 1 gives Which is certainly not the same as 5.      If , then .    False. Since the lower and upper limits are the same, .      If , then represents the total change in from to .    True. By the Second Fundamental Theorem of Calculus, .      Water flows into a tank at a rate of liters per minute, where is the time in minutes. The total amount of water that flows into the tank in the first 9 minutes is 27 liters.    True. The integral gives the total amount of water that flows into the tank from time to time minutes. Evaluate   So the total amount of water that flows into the tank in the first 9 minutes is 27 liters.      If and on an interval, then is increasing on that interval.    True. Since , if , then is increasing.      If and on an interval, then is increasing on that interval.    False. The condition does not imply that is increasing. For example, consider on . Then , and yet is decreasing on      Consider the graph of below and let .    Graph of a function f(t). The curve starts of positive from t=0 to t=3 and the graph has a labeled area of 5. The curve then goes negative from t=3 to t=8 and has a labeled area of -12. The graph passes through the points (0,0), (3,0), and (8,0).     Then .    True. We can evaluate by finding the signed area under the graph of from to which is . Since , we have .      "
},
{
  ...
  "number": "4.4",
  "title": "",
  "body": "  State and apply the First Fundamental Theorem of Calculus to compute derivatives of functions defined by integrals.  Interpret accumulation functions as total accumulated (signed) change from to and recognize them as antiderivatives.  Use the relationship to analyze accumulation functions, including determining where they are increasing, decreasing, concave up, and concave down.  State and apply the Second Fundamental Theorem of Calculus to evaluate definite integrals using antiderivatives.   "
},
{
  "id": "thm-ftc-1",
  "level": "2",
  ...
  "body": " First Fundamental Theorem of Calculus   Let be continuous on and define   Then for . In particular, is the unique antiderivative of satisfying .    Idea of a Proof  We start from the definition of the derivative: Using the splitting rule for integrals, So we have:   Here is a sketch of the graph of to illustrate the idea:   Graph of a continuous function f with a small interval [x, x+h] highlighted. The area under the curve of f from x to x+h is shaded in blue, representing the integral \\int_x^{x+h} f(t) dt. As h approaches 0, this area approximates a rectangle with height f(x) and width h, leading to the conclusion that the limit of (1\/h) times this area equals f(x).    Geometrically, the integral is the area under the curve of from to (shaded in blue above). When is small, this area is approximately a rectangle with width and height (the hatched rectangle in the image above). So therefore   As , the approximation becomes exact, so .  For those worried that this is not a rigorous proof, please see the \"Finer Details of the Proof\" below.    Finer Details of the Proof  In the proof idea, we used the approximation that when is small. But how do we know that the limit of the approximation is correct?  To control the errors, let's take the absolute minimum value and absolte maximum value of the continuous function on the closed interval (we can do this by the Extreme Value Theorem). To indicate that these values depend on , we write and . Therefore So the bounds rules for definite integrals give   As , the interval shrinks to the point , so by continuity By the squeeze theorem, , hence .  The condition and the antiderivative uniqueness theorem give the uniqueness statement.   "
},
{
  "id": "ssec-ftoc-first-ftc-3",
  "level": "2",
  "url": "sec-integral-FTC.html#ssec-ftoc-first-ftc-3",
  "type": "Remark",
  "number": "4.4.2",
  "title": "",
  "body": " In physical language: the rate of change of a cumulative effect up to time is the strength of the effect at time .  "
},
{
  "id": "ssec-ftoc-first-ftc-4",
  "level": "2",
  "url": "sec-integral-FTC.html#ssec-ftoc-first-ftc-4",
  "type": "Remark",
  "number": "4.4.3",
  "title": "",
  "body": " The First Fundamental Theorem can be used as a basic derivative rule: if is continuous, then   Here is a constant, is the input, and is a dummy variable that only matters inside the integral.  "
},
{
  "id": "ex-ftoc-problem2",
  "level": "2",
  "url": "sec-integral-FTC.html#ex-ftoc-problem2",
  "type": "Example",
  "number": "4.4.4",
  "title": "",
  "body": "  Find the derivative of .    By the First Fundamental Theorem, .  Note that we never needed to evaluate the integral or find an explicit formula for . The First Fundamental Theorem allows us to find the derivative without needing an explicit formula for .   "
},
{
  "id": "subsec-accumulation-functions-4",
  "level": "2",
  "url": "sec-integral-FTC.html#subsec-accumulation-functions-4",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "ex-accumulation-graph-analysis",
  "level": "2",
  "url": "sec-integral-FTC.html#ex-accumulation-graph-analysis",
  "type": "Example",
  "number": "4.4.5",
  "title": "",
  "body": "  Suppose the graph of is shown below. And let     A graph of on the interval shown on a grid with spacing in both the horizontal and vertical directions. The signed areas between the curve and the -axis are labeled.   Graph of a function g(t) on a grid with unit spacing. The curve passes through the points (1,0), (2,-2), (3,0), and (4,4). The region above the axis from the left endpoint to t=1 has labeled area 0.3. The region below the axis from t=1 to t=3 has labeled area -2.5. The region above the axis from t=3 to t=4 has labeled area 2.3. A dashed vertical line at t=4 marks the endpoint of the accumulated area.      Use the graph to answer the following questions.  (a) Find .  (b) Find .  (c) On which intervals is increasing?  (d) On which intervals is decreasing?  (e) Where does have a local maximum?    (a) By the definition of , we have The integral from 3 to 4 is the area of the green shaded region, which is 2.3. So .  (b) By the First Fundamental Theorem, . From the graph, , so .  (c) The function is increasing where . From the graph, this happens on the intervals and .  (d) The function is decreasing where . From the graph, this happens on the interval .  (e) Local maxima of occur where changes from positive to negative. From the graph, this happens at , so has a local maximum at . We can also check the endpoints. Since for , is increasing on , so is a local minimum. Since for , is increasing on , so is a local maximum. Therefore the local maxima of are at and .   "
},
{
  "id": "ex-accumulation-curve-sketching",
  "level": "2",
  "url": "sec-integral-FTC.html#ex-accumulation-curve-sketching",
  "type": "Example",
  "number": "4.4.7",
  "title": "",
  "body": "  Consider the function .  (a) Evaluate .  (b) Find where is increasing and where it is decreasing.  (c) Find where is concave up and where it is concave down.  (d) Use the information from parts (a)-(c) to find a rough sketch the graph of .     Part (a):   Since the lower and upper bound of the integral are the same.   Part (b):  By the First Fundamental Theorem, Since for all , the sign of is determined by the sign of . So when , and when . Therefore is increasing on and decreasing on .   Part (c)  To find where is concave up or down, we need to find the second derivative. We have Since for all , the sign of is determined by the sign of .  So when , and when . Therefore is concave up on and concave down on .   Part (d) We have the following information about the graph of :   , so the graph passes through the origin.   is increasing on and decreasing on , so the graph has a local maximum at .   is concave up on and concave down on , so the graph has an inflection point at .  Putting this all together, we get the following sketch of the graph of .  Graph of the accumulation function H(x). The graph passes through the origin, has a local maximum at x=1, and an inflection point at x=0. The graph is increasing and concave up for x less than 0, increasing and concave down for x between 0 and 1, and decreasing and concave down for x larger than 1.     "
},
{
  "id": "thm-ftc-2",
  "level": "2",
  ...
  "body": " Second Fundamental Theorem of Calculus   Suppose is an antiderivative of a continuous function on , so . Then   That is, the integral of a rate of change is the total change.    By the First Fundamental Theorem, is an antiderivative of . Any two antiderivatives differ by a constant, so . Since , we get , so . Thus , and evaluating at gives    "
},
{
  "id": "ex-ftc-evaluate-integral",
  "level": "2",
  "url": "sec-integral-FTC.html#ex-ftc-evaluate-integral",
  "type": "Example",
  "number": "4.4.9",
  "title": "",
  "body": "  Evaluate .    An antiderivative is . Apply the Second Fundamental Theorem of Calculus:    Another antiderivative is . See that you get the same answer if you use this antiderivative instead:   No matter the value of the constant, the difference will always be the same, so we get the same answer for the integral.    "
},
{
  "id": "remark-ftc-evaluation-notation",
  "level": "2",
  "url": "sec-integral-FTC.html#remark-ftc-evaluation-notation",
  "type": "Remark",
  "number": "4.4.11",
  "title": "",
  "body": " The Second Fundamental Theorem of Calculus allows us to evaluate a definite integral by finding an antiderivative. In practice, we often write the evaluation of the integral as   The notation is read as \"F of x evaluated from a to b\" and means . This is just a convenient shorthand for writing the difference of the antiderivative at the endpoints.  "
},
{
  "id": "ex-ftc-area-evaluate",
  "level": "2",
  "url": "sec-integral-FTC.html#ex-ftc-area-evaluate",
  "type": "Example",
  "number": "4.4.12",
  "title": "",
  "body": "  Determine the net area between and the -axis on the interval .    The net area is given by a definite integral   So the net area is .   "
},
{
  "id": "ex-ftc-true-false-1",
  "level": "2",
  "url": "sec-integral-FTC.html#ex-ftc-true-false-1",
  "type": "Exercise",
  "number": "1",
  "title": "",
  "body": "  The notation means .    False. The notation means .   "
},
{
  "id": "ex-ftc-true-false-2",
  "level": "2",
  "url": "sec-integral-FTC.html#ex-ftc-true-false-2",
  "type": "Exercise",
  "number": "2",
  "title": "",
  "body": "       True. An antiderivative of is , so evaluating from to gives .   "
},
{
  "id": "ex-ftc-true-false-3",
  "level": "2",
  "url": "sec-integral-FTC.html#ex-ftc-true-false-3",
  "type": "Exercise",
  "number": "3",
  "title": "",
  "body": "       False. Using the Second Fundamental Theorem of Calculus, we can evaluate both integrals. The left integral evaluates to   The right integral evaluates to   Since we know we have , so .   "
},
{
  "id": "ex-ftc-true-false-4",
  "level": "2",
  "url": "sec-integral-FTC.html#ex-ftc-true-false-4",
  "type": "Exercise",
  "number": "4",
  "title": "",
  "body": "  The area between and the -axis on the interval is .     False. The area is given by the integral . An antiderivative of is , so evaluating from 0 to 1 gives Which is certainly not the same as 5.   "
},
{
  "id": "ex-ftc-true-false-5",
  "level": "2",
  "url": "sec-integral-FTC.html#ex-ftc-true-false-5",
  "type": "Exercise",
  "number": "5",
  "title": "",
  "body": "  If , then .    False. Since the lower and upper limits are the same, .   "
},
{
  "id": "ex-ftc-true-false-6",
  "level": "2",
  "url": "sec-integral-FTC.html#ex-ftc-true-false-6",
  "type": "Exercise",
  "number": "6",
  "title": "",
  "body": "  If , then represents the total change in from to .    True. By the Second Fundamental Theorem of Calculus, .   "
},
{
  "id": "ex-ftc-true-false-7",
  "level": "2",
  "url": "sec-integral-FTC.html#ex-ftc-true-false-7",
  "type": "Exercise",
  "number": "7",
  "title": "",
  "body": "  Water flows into a tank at a rate of liters per minute, where is the time in minutes. The total amount of water that flows into the tank in the first 9 minutes is 27 liters.    True. The integral gives the total amount of water that flows into the tank from time to time minutes. Evaluate   So the total amount of water that flows into the tank in the first 9 minutes is 27 liters.   "
},
{
  "id": "ex-ftc-true-false-8",
  "level": "2",
  "url": "sec-integral-FTC.html#ex-ftc-true-false-8",
  "type": "Exercise",
  "number": "8",
  "title": "",
  "body": "  If and on an interval, then is increasing on that interval.    True. Since , if , then is increasing.   "
},
{
  "id": "ex-ftc-true-false-9",
  "level": "2",
  "url": "sec-integral-FTC.html#ex-ftc-true-false-9",
  "type": "Exercise",
  "number": "9",
  "title": "",
  "body": "  If and on an interval, then is increasing on that interval.    False. The condition does not imply that is increasing. For example, consider on . Then , and yet is decreasing on   "
},
{
  "id": "ex-ftc-true-false-10",
  "level": "2",
  "url": "sec-integral-FTC.html#ex-ftc-true-false-10",
  "type": "Exercise",
  "number": "10",
  "title": "",
  "body": "  Consider the graph of below and let .    Graph of a function f(t). The curve starts of positive from t=0 to t=3 and the graph has a labeled area of 5. The curve then goes negative from t=3 to t=8 and has a labeled area of -12. The graph passes through the points (0,0), (3,0), and (8,0).     Then .    True. We can evaluate by finding the signed area under the graph of from to which is . Since , we have .   "
},
{
  "id": "sec-integral-net",
  "level": "1",
  ...
  "body": " Net Change Theorem and Indefinite Integrals    State and interpret the Net Change Theorem, and explain how a definite integral represents the net change of a quantity whose rate is .  Understand and use indefinite integrals as notation for families of antiderivatives, including the role of the constant of integration .  Evaluate indefinite integrals using basic antiderivative formulas.  Compute total distance traveled from a velocity function using , including splitting integrals at points where the velocity changes sign.  Distinguish between net change (signed area) and total accumulated quantity (total area).     Prerequisite Review  In this section we will be integrating functions with absolute values. If you feel a bit out of practice with absolute values and piecewise functions, it may be helpful to revisit those ideas before diving into the calculus.   Review section on absolute values       In the previous section we introduced the Fundamental Theorem of Calculus , which connects derivatives and integrals. One of the most important interpretations of the definite integral is that it measures the total change of a quantity when we know its rate of change.  This idea appears in many settings. For example:   a velocity function tells us how position changes,  a growth rate tells us how a population changes,  a flow rate tells us how much fluid enters or leaves a tank.   In each case the integral accumulates the effect of a rate over time.   The Net Change Theorem  Suppose a quantity changes over time and its rate of change is .  If we want to know how much the quantity changes between times and , we can integrate the rate of change.   Net Change Theorem   If , then   In words, the definite integral of a rate of change gives the net change of the original quantity.      The rate at which water flows into a tank is liters per minute. How much water enters the tank between and minutes?    The total change is the integral of the rate:   Compute using antiderivatives:   So the tank receives liters of water during this time.      Suppose a car with position at time has velocity m\/sec. How far is the car from its starting position at seconds?    The net change in position is the integral of velocity:   Compute using antiderivatives:   The car is meters from its starting position at seconds.      Indefinite Integrals    When we write an integral without limits,   we call this an indefinite integral . It represents the family of all antiderivatives of .  That is, if , then   where is an arbitrary constant.    The constant appears because derivatives of constants are zero, so many functions share the same derivative.  Now that we have this nice notation for families of antiderivatives, we can rewrite Theorem in terms of indefinite integrals:   Basic Rules for Indefinite Integrals   The following formulas describe common indefinite integrals.     Power Rule : If , then      Logarithmic Rule :      Trigonometric Functions :                   Exponential Functions :        where and .       Inverse Trigonometric Functions :              Each formula can be verified by differentiating the result. For example, since , it follows that .    We can also rewrite the fact that you can split up integrals accross addition and subtraction, and pull out constants in terms of indefinite integrals:   Sums and Constants in Indefinite Integral   If and are integrable functions and and are constants, then     This follows from the linearity of derivatives. If and , then   Therefore is an antiderivative of , which proves the rule.      Evaluate the following indefinite integrals                     First let's expand the polynomial to simplify the integral:        Total Distance Traveled  When integrating velocity, the definite integral gives the net change in position (displacement). However, this does not always represent the total distance traveled.  If velocity becomes negative, the particle moves in the opposite direction. Negative velocity subtracts from the integral.  To compute the total distance traveled we integrate the absolute value of velocity.    If velocity is , then   Net change in position (displacement):  Total distance traveled:       A particle has velocity . Find the total distance traveled from to .    First find where velocity changes sign:   Split the integral and evaluate:   Total distance traveled: .     Similar to when we took limits or derivatives of functions involving absolute value, we need to split up integrals involving absolute value into pieces where the function is positive and negative.   Another way to understand this distinction is geometrically. Recall that the definite integral represents the net area (or signed area ) between the graph of and the -axis.  When the function is positive, the graph lies above the axis and the integral contributes a positive area. When the function is negative, the graph lies below the axis and the integral contributes a negative area.  If we apply absolute values then all the area is counted positively:    If is a function, then the total area between the curve and the axis on is given by     Taking the absolute value flips any portion of the graph that lies below the axis upward, so every region contributes positively to the area.    The graph of on the interval is shown below, with several signed areas indicated. Use these areas to evaluate .   Graph of a function f(x) with areas under the curve shaded in green and areas above the curve shaded in red. The area under the curve from x=0 to x=3 is labeled \"Area = 5\" and is shaded green. The area above the curve from x=3 to x=8 is labeled \"Area = -12\" and is shaded red. The function f(x) is also labeled on the graph.      The total area is the sum of the absolute values of the areas:       Find the total area between and the -axis on .    Total area is given by the integral of the absolute value:   In order to evaluate this integral, we need to find where the function changes sign and then split the integral into pieces:   We can verify that the function is negative on and positive on , so we can split the integral as follows:       Additional Worked-Out Examples  To keep this section at a reasonable length, we include only a few representative examples directly in the text. If you find yourself stuck on a homework problem, or if you are studying before a quiz or exam, additional fully worked-out examples are available via:  Additional Worked-Out Problems for Net Change Theorem and Indefinite Integrals      Practice \/ Study Problems   Some True\/False Problems   Determine whether each statement is true or false and briefly justify your reasoning.     If is measured in gallons per minute, then is measured in gallons.     True. Rate times time gives total change in the accumulated quantity. Here, gallons per minute times minutes gives gallons.      Suppose is measured in people per year. Then represents the population after 10 years.     False. The integral gives the change in population over the 10-year period, not the population itself. To find the final population, one would need to add the initial population.      If a particle has velocity and , then the particle did not move during the interval .     False. The integral of velocity gives net change in position. A value of 0 means the particle ended where it started, but it may still have moved back and forth during the interval.      If and , then .     False. By linearity of definite integrals, .      If , then for all .     False. Two indefinite integrals may differ by a constant. More precisely, if two antiderivative families are equal as written, the statement is ambiguous. The safer fact is that if two antiderivatives differ only by a constant, then they have the same derivative. Indefinite integrals represent families, not single functions.       .     True. We use and .       .     True. This follows directly from the basic antiderivative rules and linearity.      If a particle has velocity and for all , then its total distance traveled on equals its displacement on .     True. If velocity is always positive, the particle never reverses direction, so and therefore total distance equals net change in position.      If for all , then .     True. When , we have everywhere on the interval, so integrating both sides gives the result.      If changes sign at in the interval , then      False. When changes sign, one of those pieces must be negated when replacing by a piecewise expression. Simply splitting the integral without changing signs gives , which is the signed area, not the total area.      "
},
{
  ...
  "number": "4.5",
  "title": "",
  "body": "  State and interpret the Net Change Theorem, and explain how a definite integral represents the net change of a quantity whose rate is .  Understand and use indefinite integrals as notation for families of antiderivatives, including the role of the constant of integration .  Evaluate indefinite integrals using basic antiderivative formulas.  Compute total distance traveled from a velocity function using , including splitting integrals at points where the velocity changes sign.  Distinguish between net change (signed area) and total accumulated quantity (total area).   "
},
{
  "id": "wrn-intNet-prereq",
  "level": "2",
  "url": "sec-integral-net.html#wrn-intNet-prereq",
  "type": "Warning",
  "number": "4.5.1",
  "title": "Prerequisite Review.",
  "body": " Prerequisite Review  In this section we will be integrating functions with absolute values. If you feel a bit out of practice with absolute values and piecewise functions, it may be helpful to revisit those ideas before diving into the calculus.   Review section on absolute values      "
},
{
  "id": "sec-integral-net-4",
  "level": "2",
  "url": "sec-integral-net.html#sec-integral-net-4",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "body": " Net Change Theorem   If , then   In words, the definite integral of a rate of change gives the net change of the original quantity.   "
},
{
  "id": "ex-net-change-simple",
  "level": "2",
  "url": "sec-integral-net.html#ex-net-change-simple",
  "type": "Example",
  "number": "4.5.3",
  "title": "",
  "body": "  The rate at which water flows into a tank is liters per minute. How much water enters the tank between and minutes?    The total change is the integral of the rate:   Compute using antiderivatives:   So the tank receives liters of water during this time.   "
},
{
  ...
  "number": "4.5.4",
  "title": "",
  "body": "  Suppose a car with position at time has velocity m\/sec. How far is the car from its starting position at seconds?    The net change in position is the integral of velocity:   Compute using antiderivatives:   The car is meters from its starting position at seconds.   "
},
{
  "id": "def-indefinite-integral",
  "level": "2",
  "url": "sec-integral-net.html#def-indefinite-integral",
  "type": "Definition",
  "number": "4.5.5",
  "title": "",
  "body": "  When we write an integral without limits,   we call this an indefinite integral . It represents the family of all antiderivatives of .  That is, if , then   where is an arbitrary constant.   "
},
{
  "id": "thm-indefinite-basic-rules",
  "level": "2",
  "url": "sec-integral-net.html#thm-indefinite-basic-rules",
  "type": "Theorem",
  "number": "4.5.6",
  "title": "Basic Rules for Indefinite Integrals.",
  "body": " Basic Rules for Indefinite Integrals   The following formulas describe common indefinite integrals.     Power Rule : If , then      Logarithmic Rule :      Trigonometric Functions :                   Exponential Functions :        where and .       Inverse Trigonometric Functions :              Each formula can be verified by differentiating the result. For example, since , it follows that .   "
},
{
  "id": "thm-indefinite-linearity",
  "level": "2",
  "url": "sec-integral-net.html#thm-indefinite-linearity",
  "type": "Theorem",
  "number": "4.5.7",
  "title": "Sums and Constants in Indefinite Integral.",
  "body": " Sums and Constants in Indefinite Integral   If and are integrable functions and and are constants, then     This follows from the linearity of derivatives. If and , then   Therefore is an antiderivative of , which proves the rule.   "
},
{
  "id": "ex-indefinite-basic",
  "level": "2",
  "url": "sec-integral-net.html#ex-indefinite-basic",
  "type": "Example",
  "number": "4.5.8",
  "title": "",
  "body": "  Evaluate the following indefinite integrals                     First let's expand the polynomial to simplify the integral:     "
},
{
  "id": "def-distance-traveled",
  "level": "2",
  "url": "sec-integral-net.html#def-distance-traveled",
  "type": "Definition",
  "number": "4.5.9",
  "title": "",
  "body": "  If velocity is , then   Net change in position (displacement):  Total distance traveled:    "
},
{
  "id": "ex-distance",
  "level": "2",
  "url": "sec-integral-net.html#ex-distance",
  "type": "Example",
  "number": "4.5.10",
  "title": "",
  "body": "  A particle has velocity . Find the total distance traveled from to .    First find where velocity changes sign:   Split the integral and evaluate:   Total distance traveled: .   "
},
{
  "id": "remark-abs-value-integrals",
  "level": "2",
  "url": "sec-integral-net.html#remark-abs-value-integrals",
  "type": "Remark",
  "number": "4.5.11",
  "title": "",
  "body": " Similar to when we took limits or derivatives of functions involving absolute value, we need to split up integrals involving absolute value into pieces where the function is positive and negative.  "
},
{
  "id": "def-total-area",
  "level": "2",
  "url": "sec-integral-net.html#def-total-area",
  "type": "Definition",
  "number": "4.5.12",
  "title": "",
  "body": "  If is a function, then the total area between the curve and the axis on is given by    "
},
{
  "id": "ex-integral-totalArea",
  "level": "2",
  "url": "sec-integral-net.html#ex-integral-totalArea",
  "type": "Example",
  "number": "4.5.13",
  "title": "",
  "body": "  The graph of on the interval is shown below, with several signed areas indicated. Use these areas to evaluate .   Graph of a function f(x) with areas under the curve shaded in green and areas above the curve shaded in red. The area under the curve from x=0 to x=3 is labeled \"Area = 5\" and is shaded green. The area above the curve from x=3 to x=8 is labeled \"Area = -12\" and is shaded red. The function f(x) is also labeled on the graph.      The total area is the sum of the absolute values of the areas:    "
...
{
  "id": "ex-distance-geometry",
  "level": "2",
  "url": "sec-integral-net.html#ex-distance-geometry",
  "type": "Example",
  "number": "4.5.14",
  "title": "",
  "body": "  Find the total area between and the -axis on .    Total area is given by the integral of the absolute value:   In order to evaluate this integral, we need to find where the function changes sign and then split the integral into pieces:   We can verify that the function is negative on and positive on , so we can split the integral as follows:    "
},
{
  "id": "tf-net-01",
  "level": "2",
  "url": "sec-integral-net.html#tf-net-01",
  "type": "Exercise",
  "number": "1",
  "title": "",
  "body": "  If is measured in gallons per minute, then is measured in gallons.     True. Rate times time gives total change in the accumulated quantity. Here, gallons per minute times minutes gives gallons.   "
},
{
  "id": "tf-net-02",
  "level": "2",
  "url": "sec-integral-net.html#tf-net-02",
  "type": "Exercise",
  "number": "2",
  "title": "",
  "body": "  Suppose is measured in people per year. Then represents the population after 10 years.     False. The integral gives the change in population over the 10-year period, not the population itself. To find the final population, one would need to add the initial population.   "
},
{
  "id": "tf-net-03",
  "level": "2",
  "url": "sec-integral-net.html#tf-net-03",
  "type": "Exercise",
  "number": "3",
  "title": "",
  "body": "  If a particle has velocity and , then the particle did not move during the interval .     False. The integral of velocity gives net change in position. A value of 0 means the particle ended where it started, but it may still have moved back and forth during the interval.   "
},
{
  "id": "tf-net-04",
  "level": "2",
  "url": "sec-integral-net.html#tf-net-04",
  "type": "Exercise",
  "number": "4",
  "title": "",
  "body": "  If and , then .     False. By linearity of definite integrals, .   "
},
{
  "id": "tf-net-05",
  "level": "2",
  "url": "sec-integral-net.html#tf-net-05",
  "type": "Exercise",
  "number": "5",
  "title": "",
  "body": "  If , then for all .     False. Two indefinite integrals may differ by a constant. More precisely, if two antiderivative families are equal as written, the statement is ambiguous. The safer fact is that if two antiderivatives differ only by a constant, then they have the same derivative. Indefinite integrals represent families, not single functions.   "
},
{
  "id": "tf-net-06",
  "level": "2",
  "url": "sec-integral-net.html#tf-net-06",
  "type": "Exercise",
  "number": "6",
  "title": "",
  "body": "   .     True. We use and .   "
},
{
  "id": "tf-net-07",
  "level": "2",
  "url": "sec-integral-net.html#tf-net-07",
  "type": "Exercise",
  "number": "7",
  "title": "",
  "body": "   .     True. This follows directly from the basic antiderivative rules and linearity.   "
},
{
  "id": "tf-net-08",
  "level": "2",
  "url": "sec-integral-net.html#tf-net-08",
  "type": "Exercise",
  "number": "8",
  "title": "",
  "body": "  If a particle has velocity and for all , then its total distance traveled on equals its displacement on .     True. If velocity is always positive, the particle never reverses direction, so and therefore total distance equals net change in position.   "
},
{
  "id": "tf-net-09",
  "level": "2",
  "url": "sec-integral-net.html#tf-net-09",
  "type": "Exercise",
  "number": "9",
  "title": "",
  "body": "  If for all , then .     True. When , we have everywhere on the interval, so integrating both sides gives the result.   "
},
{
  "id": "tf-net-10",
  "level": "2",
  "url": "sec-integral-net.html#tf-net-10",
  "type": "Exercise",
  "number": "10",
  "title": "",
  "body": "  If changes sign at in the interval , then      False. When changes sign, one of those pieces must be negated when replacing by a piecewise expression. Simply splitting the integral without changing signs gives , which is the signed area, not the total area.   "
},
{
  ...
  "body": " Substitution Rule for Integration    Recognize when an integrand has the form and apply substitution.  Use substitution to evaluate indefinite integrals and then check results by differentiation.  Use substitution to evaluate definite integrals.  Use symmetry (even\/odd functions) to evaluate certain definite integrals quickly.     Reversing the Chain Rule  In this section we develop a powerful method for finding antiderivatives by reversing the Chain Rule:   Let's see an example of this in action before we develop a systematic method for applying it.     Find the derivative of     By the Chain Rule, .      Use you answer from (a) to help evaluate .    Since , we have   We can check this by differentiating: .     Notice in our last example, the inside function appears inside the cosine, and its derivative is also appeared in the integrand (off by only a constant) so were were able to rewrite it to match the Chain Rule pattern.   U-Substitution Technique    Given an integral . Try to identify an inside function so that appears as a factor (possibly after multiplying and dividing by a constant):   After factoring out , rewrite the remaining part as a function of .    Using the symbolic notation and Then rewrite the integral in :    Compute using basic antiderivatives and rules.    Substitute back to express the final answer in terms of :      Let's try Example again this time with the substitution method in mind.    Evaluate .    We want to identify an inside function so that appears as a factor in the integrand. The only reasonable choice is , since it appears inside the cosine and its derivative is a constant multiple of the other factor in the integrand:  So with , we have , so . Then the integral becomes     Notice that the substitution method is just a systematic way to reverse the Chain Rule. In the previous example, we identified the inside function and its derivative by inspection, but here we are more methodical. We first identify the inside function and then rewrite the integral in terms of .  Let's get some more practice!    Evaluate .  Check your answer by differentiating.    Let . Then . Rewrite to produce :   Check by differentiating: So the derivative of our answer matches the original integrand, confirming that our antiderivative is correct.    We can also evaluate definite integrals with substitution by first evaluating the antiderivative and then applying the Fundamental Theorem of Calculus.    Evaluate .    First let's drop the limits and focus on finding an antiderivative.   Using our u-substitution method, let . Then , so .   Now we can apply the Fundamental Theorem of Calculus to evaluate the original definite integral:     Alternatively for definite integrals we could have instead updated the limits of integration to be in terms of and then evaluated the resulting integral without first finding an antiderivative in terms of .    Evaluate by substituting and updating the limits of integration.    Let . Then , so . Update the limits: when , .  when , .     Notice that we get the same answer as in Example , but we never had to write down an antiderivative in terms of or apply the Fundamental Theorem of Calculus in terms of .      Two Important Results  Using our substitution method we can find antiderivatives of some important functions that we will need later in Calculus 2 and beyond.         First we should recognize that , so the integral becomes   Let . Then , so . Then            Multiply and divide the integrand by so we can rewrite it as:   Let , then . So now we can evaluate:       Integral Symmetry for Even and Odd Functions  The last application of substitution we will discuss in this section is using symmetry to evaluate certain definite integrals quickly.  If you need a quick reminder about even and odd functions, we discussed them earlier in the course in the Curve Sketching Section of the text. The following result provides a powerful tool for evaluating definite integrals of even and odd functions.   Integral Symmetry Theorem    If is odd, meaning , then for any ,     If is even, meaning , then for any ,       Suppose is an odd function. Then   Let , then and change the bounds of our first integral. When , .  When , .  So the first integral becomes   Since is odd, , so the first integral becomes   So now we have   The proof for even functions is similar, but we use the fact that instead of .    While the result for even functions can speed up the evaluation of definite integrals (since evaluating at is often simpler), the result for odd functions can make some otherwise difficult integrals much easier to evaluate.    Evaluate .    The integrand is odd because . By the symmetry theorem,       Additional Worked-Out Examples  To keep this section at a reasonable length, we include only a few representative examples directly in the text. If you find yourself stuck on a homework problem, or if you are studying before a quiz or exam, additional fully worked-out examples are available via:  Additional Worked-Out Problems for Substitution Rule for Integration      Practice \/ Study Problems   Some True\/False Problems   Determine whether each statement is true or false and briefly justify your reasoning.      .     True. Let , then , so . Then So the statement is true.      The substitution is useful for evaluating .     True. Let , then , so . Then So the substitution is useful for evaluating the integral, and the statement is true.      If , then .     False. Let , then , so . Then So the statement is false.       .     False. Let , then , so . Then So the statement is false.      If then .     True. Let , then , so . Then So the statement is true.      If and the limits of integration are changed to -values, then it is unnecessary to substitute back to after integrating.     True. When changing variables, the limits of integration are also changed to match the new variable. Therefore, there is no need to substitute back to the original variable after integrating.      If is odd, then .     True. Since is odd, . So So the statement is true.      If is even and is odd, then .     True. Since is even and is odd, the product is odd. Therefore, by the symmetry theorem, .      "
},
{
  ...
  "number": "4.6",
  "title": "",
  "body": "  Recognize when an integrand has the form and apply substitution.  Use substitution to evaluate indefinite integrals and then check results by differentiation.  Use substitution to evaluate definite integrals.  Use symmetry (even\/odd functions) to evaluate certain definite integrals quickly.   "
},
{
  "id": "ex-reverse-chain-01",
  "level": "2",
  "url": "sec-integral-usub.html#ex-reverse-chain-01",
  "type": "Example",
  "number": "4.6.1",
  "title": "",
  "body": "   Find the derivative of     By the Chain Rule, .      Use you answer from (a) to help evaluate .    Since , we have   We can check this by differentiating: .    "
},
{
  "id": "ssec-reverse-chain-7",
  "level": "2",
  "url": "sec-integral-usub.html#ssec-reverse-chain-7",
  "type": "Strategy",
  "number": "4.6.2",
  "title": "U-Substitution Technique.",
  "body": " U-Substitution Technique    Given an integral . Try to identify an inside function so that appears as a factor (possibly after multiplying and dividing by a constant):   After factoring out , rewrite the remaining part as a function of .    Using the symbolic notation and Then rewrite the integral in :    Compute using basic antiderivatives and rules.    Substitute back to express the final answer in terms of :     "
},
{
  "id": "ex-sub-00",
  "level": "2",
  "url": "sec-integral-usub.html#ex-sub-00",
  "type": "Example",
  "number": "4.6.3",
  "title": "",
  "body": "  Evaluate .    We want to identify an inside function so that appears as a factor in the integrand. The only reasonable choice is , since it appears inside the cosine and its derivative is a constant multiple of the other factor in the integrand:  So with , we have , so . Then the integral becomes    "
},
{
  "id": "ex-sub-01",
  "level": "2",
  ...
  "number": "4.6.4",
  "title": "",
  "body": "  Evaluate .  Check your answer by differentiating.    Let . Then . Rewrite to produce :   Check by differentiating: So the derivative of our answer matches the original integrand, confirming that our antiderivative is correct.   "
},
{
  "id": "ex-sub-def-02",
  "level": "2",
  "url": "sec-integral-usub.html#ex-sub-def-02",
  "type": "Example",
  "number": "4.6.5",
  "title": "",
  "body": "  Evaluate .    First let's drop the limits and focus on finding an antiderivative.   Using our u-substitution method, let . Then , so .   Now we can apply the Fundamental Theorem of Calculus to evaluate the original definite integral:    "
},
{
  "id": "ex-sub-def-03",
  "level": "2",
  "url": "sec-integral-usub.html#ex-sub-def-03",
  "type": "Example",
  "number": "4.6.6",
  "title": "",
  "body": "  Evaluate by substituting and updating the limits of integration.    Let . Then , so . Update the limits: when , .  when , .     Notice that we get the same answer as in Example , but we never had to write down an antiderivative in terms of or apply the Fundamental Theorem of Calculus in terms of .   "
},
{
  "id": "thm-tan-integral",
  "level": "2",
  "url": "sec-integral-usub.html#thm-tan-integral",
  "type": "Theorem",
  "number": "4.6.7",
  "title": "",
  "body": "       First we should recognize that , so the integral becomes   Let . Then , so . Then    "
},
{
  "id": "thm-sec-integral",
  "level": "2",
  "url": "sec-integral-usub.html#thm-sec-integral",
  "type": "Theorem",
  "number": "4.6.8",
  "title": "",
  "body": "       Multiply and divide the integrand by so we can rewrite it as:   Let , then . So now we can evaluate:    "
},
{
  ...
  "body": " Integral Symmetry Theorem    If is odd, meaning , then for any ,     If is even, meaning , then for any ,     "
},
{
  "id": "ssec-integral-symmetry-5",
  "level": "2",
  "url": "sec-integral-usub.html#ssec-integral-symmetry-5",
  "type": "Proof",
  "number": "1",
  "title": "",
  "body": " Suppose is an odd function. Then   Let , then and change the bounds of our first integral. When , .  When , .  So the first integral becomes   Since is odd, , so the first integral becomes   So now we have   The proof for even functions is similar, but we use the fact that instead of .   "
},
{
...
},
{
  "id": "ex-true-false-06",
  "level": "2",
  "url": "sec-integral-usub.html#ex-true-false-06",
  "type": "Exercise",
  "number": "1",
  "title": "",
  "body": "   .     True. Let , then , so . Then So the statement is true.   "
},
{
  "id": "ex-true-false-03",
  "level": "2",
  "url": "sec-integral-usub.html#ex-true-false-03",
  "type": "Exercise",
  "number": "2",
  "title": "",
  "body": "  The substitution is useful for evaluating .     True. Let , then , so . Then So the substitution is useful for evaluating the integral, and the statement is true.   "
},
{
  "id": "ex-true-false-01",
  "level": "2",
  "url": "sec-integral-usub.html#ex-true-false-01",
  "type": "Exercise",
  "number": "3",
  "title": "",
  "body": "  If , then .     False. Let , then , so . Then So the statement is false.   "
},
{
  "id": "ex-true-false-07",
  "level": "2",
  "url": "sec-integral-usub.html#ex-true-false-07",
  "type": "Exercise",
  "number": "4",
  "title": "",
  "body": "   .     False. Let , then , so . Then So the statement is false.   "
},
{
  "id": "ex-true-false-08",
  "level": "2",
  "url": "sec-integral-usub.html#ex-true-false-08",
  "type": "Exercise",
  "number": "5",
  "title": "",
  "body": "  If then .     True. Let , then , so . Then So the statement is true.   "
},
{
  "id": "ex-true-false-04",
  "level": "2",
  "url": "sec-integral-usub.html#ex-true-false-04",
  "type": "Exercise",
  "number": "6",
  "title": "",
  "body": "  If and the limits of integration are changed to -values, then it is unnecessary to substitute back to after integrating.     True. When changing variables, the limits of integration are also changed to match the new variable. Therefore, there is no need to substitute back to the original variable after integrating.   "
},
{
  "id": "ex-true-false-02",
  "level": "2",
  "url": "sec-integral-usub.html#ex-true-false-02",
  "type": "Exercise",
  "number": "7",
  "title": "",
  "body": "  If is odd, then .     True. Since is odd, . So So the statement is true.   "
},
{
  "id": "ex-true-false-05",
  "level": "2",
  "url": "sec-integral-usub.html#ex-true-false-05",
  "type": "Exercise",
  "number": "8",
  "title": "",
  "body": "  If is even and is odd, then .     True. Since is even and is odd, the product is odd. Therefore, by the symmetry theorem, .   "
},
{
  "id": "sec-integral-ww",
  "level": "1",
  ...
  "number": "4.7",
  "title": "Additional Worked-Out Problems",
  "body": " Additional Worked-Out Problems   Antiderivatives    Find the most general antiderivative of Check your answer by differentiating.    First rewrite the function using exponents:   Now use the rules for antiderivatives of powers and trigonometric functions, along with linearity, to build an antiderivative term-by-term:   We can check our answer by differentiating:   Since differentiating recovers the original function, the result is confirmed as the most general antiderivative.      Find the antiderivative of which satisfies .    First rewrite the function using exponents:   Now use the rules for antiderivatives of powers, along with linearity, to build the most general antiderivative term-by-term:   Simplifying gives   Since , substitute to find :   Solving for , we get   Therefore, the antiderivative is   We can check our answer by differentiating and verifying the given value:    Since and , the result is confirmed.      Find the most general antiderivative of Check your answer by differentiating.    First simplify the expression and rewrite using exponents:   Now use the rules for antiderivatives of powers, along with linearity, to build an antiderivative term-by-term:   Simplifying gives   We can check our answer by differentiating:   Since differentiating recovers the original function, the result is confirmed as the most general antiderivative.      An object moves along a coordinate line with velocity (in units per second). Its initial position is 5 units to the left of the origin. Find the position of the object after 3 seconds.    Let be the position of the object at time . Since velocity is the derivative of position, we have   Thus is an antiderivative of . Using the rules for antiderivatives , we obtain the most general form:   We are given that the initial position is 5 units to the left of the origin, so . Substituting:   Therefore , and the position function is   To find the position after 3 seconds, evaluate:   Since the position is positive, the object is 28 units to the right of the origin after 3 seconds.  We can check our work by differentiating:   Since differentiating recovers the given velocity, the result is confirmed.      Solve the initial value problem:     Our goal is to find a function such that and .  First, we find the most general antiderivative of the right-hand side by using the rules for antiderivatives .   Now we use the initial condition to solve for :   Therefore, the solution to the initial value problem is       A small population is decreasing over time. Let be the population after years. Suppose the rate of change is modeled by     Write a general formula for assuming an unknown initial population.    If the initial population is , find the specific formula for .    According to the model, what will the population be after 3 years?      (a) Since is given, the function is an antiderivative of .  Using the rules for antiderivatives , we obtain:   Simplifying gives   This is the general formula.  (b) Now use the initial condition :   Therefore, the specific formula is   (c) Now evaluate at :   With access to a calculator (if one is permitted), we can find a decimal approximation to be about .      Riemann Sums and Areas   Comparing Left, Right, Upper, and Lower Sums   Estimate the area under the graph of on the interval using rectangles of equal width.   Graph of a downward-opening parabola labeled f(x) with shaded area under the curve from x = -2 to x = 1    Compute:   the left Riemann sum  the right Riemann sum  an overestimate (upper sum)  an underestimate (lower sum)     First compute the width of each rectangle:   The partition points are:   The subintervals are:   (a) Left Riemann Sum    Graphically, the left sum corresponds to rectangles that touch the curve at the left endpoints of the subintervals.   Graph of a downward-opening parabola labeled f(x) with shaded area under the curve from x = -2 to x = 1, with rectangles drawn touching the curve at the left endpoints of the subintervals [-2,-1], [-1,0], and [0,1]    (b) Right Riemann Sum    Graphically, the right sum corresponds to rectangles that touch the curve at the right endpoints of the subintervals.   Graph of a downward-opening parabola labeled f(x) with shaded area under the curve from x = -2 to x = 1, with rectangles drawn touching the curve at the right endpoints of the subintervals [-2,-1], [-1,0], and [0,1]    (c) Upper Sum (Overestimate)  To determine upper and lower sums, note that is increasing on and decreasing on .  Use the maximum value on each subinterval:     Graph of a downward-opening parabola labeled f(x) with shaded area under the curve from x = -2 to x = 1, with rectangles drawn touching the curve at the maximum value on each subinterval: at x = -1 for [-2,-1], at x = 0 for [-1,0], and at x = 0 for [0,1]    (d) Lower Sum (Underestimate)  Use the minimum value on each subinterval:     Graph of a downward-opening parabola labeled f(x) with shaded area under the curve from x = -2 to x = 1, with rectangles drawn touching the curve at the minimum value on each subinterval: at x = -2 for [-2,-1], at x = -1 for [-1,0], and at x = 1 for [0,1]    So we have:   The left and right sums, and , fall between these bounds.     Estimating Distance from a Velocity Table   The following table gives the velocity (in ft\/s) of a particle moving along a horizontal axis at different times (in seconds).   Estimate the distance traveled by the particle from to using 4 subintervals of equal width.   Use left endpoints.  Use right endpoints.  Find an overestimate of the distance assuming all minimums and maximums are at the endpoints.     First compute the width of each subinterval:   (a) Left Endpoint Approximation  The left endpoints are:   So the estimated distance is:   (b) Right Endpoint Approximation  The right endpoints are:   So the estimated distance is:   (c) Overestimate  To find an overestimate, take the maximum velocity on each subinterval. Because we are told that all minimums and maximums are at the endpoints, we only need to look at the values in the table:   So the overestimate is:   Therefore, the distance traveled is approximately between feet and feet, with the left sum giving feet.      Definite Integrals    The graph of the rate of change of temperature (in degrees Fahrenheit per hour) over a 5-hour period can be viewed at the following link: Interactive Desmos Graph .  Here, is measured in hours. Positive values of mean the temperature is increasing, while negative values mean the temperature is decreasing.  Use the interactive graph to explore the accumulation of and answer the following questions.   If the temperature is at , what is the temperature after 5 hours?  After how many hours is the temperature highest?  What is the highest temperature reached during the 5-hour period?     (a) The temperature after 5 hours is the initial temperature plus the accumulation of the rate of change over the 5-hour period. This can be expressed as:   Using the interactive graph, we can estimate the value of the integral. By adjusting the bounds of integration and observing the accumulated area under the curve of , we find that:   Therefore, the temperature after 5 hours is approximately:   (b) To find when the temperature is highest, we need to look for the time at which the accumulation of reaches its maximum. This occurs when the integral of from 0 to is at its maximum value. By exploring the graph, we can see that the temperature reaches its highest point around hours.  (c) To find the highest temperature reached, we can evaluate the temperature at hours:   Using the interactive graph, we estimate:   Therefore, the highest temperature reached during the 5-hour period is approximately:       Evaluate the integral below by interpreting it in terms of areas. In other words, sketch the graph of the integrand and compute the integral using geometry.     First let's sketch the function . These absolute value functions are V-shaped, and the vertex occurs where the expression inside the absolute value is zero.  Setting gives . So the vertex is at the point .  We can also plot the endpoints of the interval: and . and connect these points with straight lines to get the graph of .   Graph of the function f(x) = |3x - 6|, which is a V-shaped graph with a vertex at (2, 0), and points at (-1, 9) and (3, 3).    We can see from the graph that the region under the function forms 2 triangles both above the -axis. The area of the triangle on the left is:   The area of the triangle on the right is:   Therefore, the value of the integral is the sum of these two areas:       The Fundamental Theorem of Calculus    Evaluate the definite integral:     First expand the integrand:   Now apply the Fundamental Theorem of Calculus:   Evaluate at the bounds:   Therefore,       Use a definite integral to find the area of the region that lies under the curve and above the -axis.    First determine where the curve intersects the -axis by solving:    The curve is above the -axis on the interval , so the area is given by:   Evaluate the integral and simplify:   Therefore, the area of the region is .      Evaluate the definite integral:     We saw in a previous example that this can also be solved by using a geometric approach, but here we will evaluate the integral using the definition of the absolute value function and the Fundamental Theorem of Calculus. Of course if such a problem appears on an exam and it does not specify a method, you can choose either approach.  First determine where the expression inside the absolute value is zero:   So we write as a piecewise function:   Split the integral at :   Evaluate each integral:   Compute the values:   Add the results:       Evaluate the integral     Thinking back to our antiderivative rules , we know that the derivative of is . So we can use the Fundamental Theorem of Calculus to evaluate the integral:       Net Change Theorem and Indefinite Integrals    Complete each statement below by determining the correct units of the definite integral.   If is measured in degrees Fahrenheit per hour and is measured in hours, then has what units?  If is measured in pounds per square foot and is measured in feet, then has what units?     (a) The units of are the product of the units of and . Since is in degrees Fahrenheit per hour and is in hours, the units of the integral are:   (b) The units of are the product of the units of and . Since is in pounds per square foot and is in feet, the units of the integral are:       Two mice, Charlie and Frank, race down a straight hallway as far as they can for 30 seconds. Let their velocity functions be denoted by and respectively, where velocity is measured in centimeters per second and time is measured in seconds.  Open this Desmos interactive graph and use it to answer the following questions.   During the race, what is the maximum velocity of each mouse?  Which mouse was ahead seconds into the race, and by how much?  At what time during the race does Charlie first pull ahead of Frank?  Who won the race (who is ahead at )?     (a) To find the maximum velocity of each mouse, look for the highest point on each velocity graph. The y-coordinate of this point will give the maximum velocity in centimeters per second.  For Charlie, the maximum velocity is approximately cm\/s, and for Frank, the maximum velocity is approximately cm\/s.  (b) To determine which mouse is ahead at time , we need to compute the accumulated distance traveled by each mouse up to that time. The distance traveled by a mouse from time 0 to time 8 can be found by evaluating the definite integral of its velocity function:   (c) To find when Charlie first pulls ahead of Frank, look for the first time at which becomes larger than . Using the slider we can find that this occurs at approximately seconds.  (d) To determine who won the race, we need to compare the total distance traveled by each mouse at . This can be found by evaluating the definite integrals:   Therefore, Charlie won the race      A fish population in a lake is at time . The population is changing at a rate of   fish per month, where is measured in months. What is the fish population after months?    Since is the rate of change of the population, the total change in population from to is(according to the Net Change Theorem):   Now evaluate the integral (by finding the antiderivative).   Therefore the change in population from to is,   Thus, the fish population after months is the initial population plus the change in population:   Using a calculator to approximate,   So after months, the fish population is about . If you did not have a calculator (like on an exam), you should leave the answer in the form .      Substitution Rule for Integration    Evaluate .    Let , so and . We also solve for : gives .       Evaluate .    Let . Then , so .       Evaluate in two ways, and explain why the answers agree.    Method 1: Let . Then .   Method 2: Write the integrand as and let . Then .   These differ by a constant because . So , meaning the two antiderivative families are the same.      Consider the function    Find an antiderivative of .  Evaluate .     (a) Let . Then .   (b) Now we can evaluate the definite integral:      "
},
{
  "id": "ex-antiderivative-linear-combo",
  "level": "2",
  "url": "sec-integral-ww.html#ex-antiderivative-linear-combo",
  "type": "Example",
  "number": "4.7.1",
  "title": "",
  "body": "  Find the most general antiderivative of Check your answer by differentiating.    First rewrite the function using exponents:   Now use the rules for antiderivatives of powers and trigonometric functions, along with linearity, to build an antiderivative term-by-term:   We can check our answer by differentiating:   Since differentiating recovers the original function, the result is confirmed as the most general antiderivative.   "
},
{
  "id": "ex-antiderivative-initial-condition-rational",
  "level": "2",
  "url": "sec-integral-ww.html#ex-antiderivative-initial-condition-rational",
  "type": "Example",
  "number": "4.7.2",
  "title": "",
  "body": "  Find the antiderivative of which satisfies .    First rewrite the function using exponents:   Now use the rules for antiderivatives of powers, along with linearity, to build the most general antiderivative term-by-term:   Simplifying gives   Since , substitute to find :   Solving for , we get   Therefore, the antiderivative is   We can check our answer by differentiating and verifying the given value:    Since and , the result is confirmed.   "
},
{
  "id": "ex-antiderivative-radical-quotient",
  "level": "2",
  "url": "sec-integral-ww.html#ex-antiderivative-radical-quotient",
  "type": "Example",
  "number": "4.7.3",
  "title": "",
  "body": "  Find the most general antiderivative of Check your answer by differentiating.    First simplify the expression and rewrite using exponents:   Now use the rules for antiderivatives of powers, along with linearity, to build an antiderivative term-by-term:   Simplifying gives   We can check our answer by differentiating:   Since differentiating recovers the original function, the result is confirmed as the most general antiderivative.   "
},
{
  "id": "ex-antiderivative-motion-position",
  "level": "2",
  "url": "sec-integral-ww.html#ex-antiderivative-motion-position",
  "type": "Example",
  "number": "4.7.4",
  "title": "",
  "body": "  An object moves along a coordinate line with velocity (in units per second). Its initial position is 5 units to the left of the origin. Find the position of the object after 3 seconds.    Let be the position of the object at time . Since velocity is the derivative of position, we have   Thus is an antiderivative of . Using the rules for antiderivatives , we obtain the most general form:   We are given that the initial position is 5 units to the left of the origin, so . Substituting:   Therefore , and the position function is   To find the position after 3 seconds, evaluate:   Since the position is positive, the object is 28 units to the right of the origin after 3 seconds.  We can check our work by differentiating:   Since differentiating recovers the given velocity, the result is confirmed.   "
},
{
  "id": "ex-antiderivative-initial-value-problem",
  "level": "2",
  "url": "sec-integral-ww.html#ex-antiderivative-initial-value-problem",
  "type": "Example",
  "number": "4.7.5",
  "title": "",
  "body": "  Solve the initial value problem:     Our goal is to find a function such that and .  First, we find the most general antiderivative of the right-hand side by using the rules for antiderivatives .   Now we use the initial condition to solve for :   Therefore, the solution to the initial value problem is    "
},
{
  "id": "ex-antiderivative-population-model",
  "level": "2",
  "url": "sec-integral-ww.html#ex-antiderivative-population-model",
  "type": "Example",
  "number": "4.7.6",
  "title": "",
  "body": "  A small population is decreasing over time. Let be the population after years. Suppose the rate of change is modeled by     Write a general formula for assuming an unknown initial population.    If the initial population is , find the specific formula for .    According to the model, what will the population be after 3 years?      (a) Since is given, the function is an antiderivative of .  Using the rules for antiderivatives , we obtain:   Simplifying gives   This is the general formula.  (b) Now use the initial condition :   Therefore, the specific formula is   (c) Now evaluate at :   With access to a calculator (if one is permitted), we can find a decimal approximation to be about .   "
},
{
  "id": "ex-riemann-all-sums",
  "level": "2",
  "url": "sec-integral-ww.html#ex-riemann-all-sums",
  "type": "Example",
  "number": "4.7.7",
  "title": "Comparing Left, Right, Upper, and Lower Sums.",
  "body": " Comparing Left, Right, Upper, and Lower Sums   Estimate the area under the graph of on the interval using rectangles of equal width.   Graph of a downward-opening parabola labeled f(x) with shaded area under the curve from x = -2 to x = 1    Compute:   the left Riemann sum  the right Riemann sum  an overestimate (upper sum)  an underestimate (lower sum)     First compute the width of each rectangle:   The partition points are:   The subintervals are:   (a) Left Riemann Sum    Graphically, the left sum corresponds to rectangles that touch the curve at the left endpoints of the subintervals.   Graph of a downward-opening parabola labeled f(x) with shaded area under the curve from x = -2 to x = 1, with rectangles drawn touching the curve at the left endpoints of the subintervals [-2,-1], [-1,0], and [0,1]    (b) Right Riemann Sum    Graphically, the right sum corresponds to rectangles that touch the curve at the right endpoints of the subintervals.   Graph of a downward-opening parabola labeled f(x) with shaded area under the curve from x = -2 to x = 1, with rectangles drawn touching the curve at the right endpoints of the subintervals [-2,-1], [-1,0], and [0,1]    (c) Upper Sum (Overestimate)  To determine upper and lower sums, note that is increasing on and decreasing on .  Use the maximum value on each subinterval:     Graph of a downward-opening parabola labeled f(x) with shaded area under the curve from x = -2 to x = 1, with rectangles drawn touching the curve at the maximum value on each subinterval: at x = -1 for [-2,-1], at x = 0 for [-1,0], and at x = 0 for [0,1]    (d) Lower Sum (Underestimate)  Use the minimum value on each subinterval:     Graph of a downward-opening parabola labeled f(x) with shaded area under the curve from x = -2 to x = 1, with rectangles drawn touching the curve at the minimum value on each subinterval: at x = -2 for [-2,-1], at x = -1 for [-1,0], and at x = 1 for [0,1]    So we have:   The left and right sums, and , fall between these bounds.   "
},
{
  "id": "ex-riemann-velocity-table",
  "level": "2",
  "url": "sec-integral-ww.html#ex-riemann-velocity-table",
  "type": "Example",
  "number": "4.7.8",
  "title": "Estimating Distance from a Velocity Table.",
  "body": " Estimating Distance from a Velocity Table   The following table gives the velocity (in ft\/s) of a particle moving along a horizontal axis at different times (in seconds).   Estimate the distance traveled by the particle from to using 4 subintervals of equal width.   Use left endpoints.  Use right endpoints.  Find an overestimate of the distance assuming all minimums and maximums are at the endpoints.     First compute the width of each subinterval:   (a) Left Endpoint Approximation  The left endpoints are:   So the estimated distance is:   (b) Right Endpoint Approximation  The right endpoints are:   So the estimated distance is:   (c) Overestimate  To find an overestimate, take the maximum velocity on each subinterval. Because we are told that all minimums and maximums are at the endpoints, we only need to look at the values in the table:   So the overestimate is:   Therefore, the distance traveled is approximately between feet and feet, with the left sum giving feet.   "
},
{
  "id": "ex-accum-temp-rate",
  "level": "2",
  "url": "sec-integral-ww.html#ex-accum-temp-rate",
  "type": "Example",
  "number": "4.7.9",
  "title": "",
  "body": "  The graph of the rate of change of temperature (in degrees Fahrenheit per hour) over a 5-hour period can be viewed at the following link: Interactive Desmos Graph .  Here, is measured in hours. Positive values of mean the temperature is increasing, while negative values mean the temperature is decreasing.  Use the interactive graph to explore the accumulation of and answer the following questions.   If the temperature is at , what is the temperature after 5 hours?  After how many hours is the temperature highest?  What is the highest temperature reached during the 5-hour period?     (a) The temperature after 5 hours is the initial temperature plus the accumulation of the rate of change over the 5-hour period. This can be expressed as:   Using the interactive graph, we can estimate the value of the integral. By adjusting the bounds of integration and observing the accumulated area under the curve of , we find that:   Therefore, the temperature after 5 hours is approximately:   (b) To find when the temperature is highest, we need to look for the time at which the accumulation of reaches its maximum. This occurs when the integral of from 0 to is at its maximum value. By exploring the graph, we can see that the temperature reaches its highest point around hours.  (c) To find the highest temperature reached, we can evaluate the temperature at hours:   Using the interactive graph, we estimate:   Therefore, the highest temperature reached during the 5-hour period is approximately:    "
},
{
  "id": "ex-area-abs-signed",
  "level": "2",
  "url": "sec-integral-ww.html#ex-area-abs-signed",
  "type": "Example",
  "number": "4.7.10",
  "title": "",
  "body": "  Evaluate the integral below by interpreting it in terms of areas. In other words, sketch the graph of the integrand and compute the integral using geometry.     First let's sketch the function . These absolute value functions are V-shaped, and the vertex occurs where the expression inside the absolute value is zero.  Setting gives . So the vertex is at the point .  We can also plot the endpoints of the interval: and . and connect these points with straight lines to get the graph of .   Graph of the function f(x) = |3x - 6|, which is a V-shaped graph with a vertex at (2, 0), and points at (-1, 9) and (3, 3).    We can see from the graph that the region under the function forms 2 triangles both above the -axis. The area of the triangle on the left is:   The area of the triangle on the right is:   Therefore, the value of the integral is the sum of these two areas:    "
},
{
  "id": "ex-definite-integral-polynomial",
  "level": "2",
  "url": "sec-integral-ww.html#ex-definite-integral-polynomial",
  "type": "Example",
  "number": "4.7.11",
  "title": "",
  "body": "  Evaluate the definite integral:     First expand the integrand:   Now apply the Fundamental Theorem of Calculus:   Evaluate at the bounds:   Therefore,    "
},
{
  "id": "ex-area-parabola",
  "level": "2",
  "url": "sec-integral-ww.html#ex-area-parabola",
  "type": "Example",
  "number": "4.7.12",
  "title": "",
  "body": "  Use a definite integral to find the area of the region that lies under the curve and above the -axis.    First determine where the curve intersects the -axis by solving:    The curve is above the -axis on the interval , so the area is given by:   Evaluate the integral and simplify:   Therefore, the area of the region is .   "
},
{
  "id": "ex-abs-value-integral",
  "level": "2",
  "url": "sec-integral-ww.html#ex-abs-value-integral",
  "type": "Example",
  "number": "4.7.13",
  "title": "",
  "body": "  Evaluate the definite integral:     We saw in a previous example that this can also be solved by using a geometric approach, but here we will evaluate the integral using the definition of the absolute value function and the Fundamental Theorem of Calculus. Of course if such a problem appears on an exam and it does not specify a method, you can choose either approach.  First determine where the expression inside the absolute value is zero:   So we write as a piecewise function:   Split the integral at :   Evaluate each integral:   Compute the values:   Add the results:    "
},
{
  "id": "ex-definite-integral-trig",
  "level": "2",
  "url": "sec-integral-ww.html#ex-definite-integral-trig",
  "type": "Example",
  "number": "4.7.14",
  "title": "",
  "body": "  Evaluate the integral     Thinking back to our antiderivative rules , we know that the derivative of is . So we can use the Fundamental Theorem of Calculus to evaluate the integral:    "
},
{
  "id": "ex-units-integral-mixed",
  "level": "2",
  "url": "sec-integral-ww.html#ex-units-integral-mixed",
  "type": "Example",
  "number": "4.7.15",
  "title": "",
  "body": "  Complete each statement below by determining the correct units of the definite integral.   If is measured in degrees Fahrenheit per hour and is measured in hours, then has what units?  If is measured in pounds per square foot and is measured in feet, then has what units?     (a) The units of are the product of the units of and . Since is in degrees Fahrenheit per hour and is in hours, the units of the integral are:   (b) The units of are the product of the units of and . Since is in pounds per square foot and is in feet, the units of the integral are:    "
},
{
  "id": "ex-mice-race-charlie-frank",
  "level": "2",
  "url": "sec-integral-ww.html#ex-mice-race-charlie-frank",
  "type": "Example",
  "number": "4.7.16",
  "title": "",
  "body": "  Two mice, Charlie and Frank, race down a straight hallway as far as they can for 30 seconds. Let their velocity functions be denoted by and respectively, where velocity is measured in centimeters per second and time is measured in seconds.  Open this Desmos interactive graph and use it to answer the following questions.   During the race, what is the maximum velocity of each mouse?  Which mouse was ahead seconds into the race, and by how much?  At what time during the race does Charlie first pull ahead of Frank?  Who won the race (who is ahead at )?     (a) To find the maximum velocity of each mouse, look for the highest point on each velocity graph. The y-coordinate of this point will give the maximum velocity in centimeters per second.  For Charlie, the maximum velocity is approximately cm\/s, and for Frank, the maximum velocity is approximately cm\/s.  (b) To determine which mouse is ahead at time , we need to compute the accumulated distance traveled by each mouse up to that time. The distance traveled by a mouse from time 0 to time 8 can be found by evaluating the definite integral of its velocity function:   (c) To find when Charlie first pulls ahead of Frank, look for the first time at which becomes larger than . Using the slider we can find that this occurs at approximately seconds.  (d) To determine who won the race, we need to compare the total distance traveled by each mouse at . This can be found by evaluating the definite integrals:   Therefore, Charlie won the race   "
},
{
  "id": "ex-netchange-fish-population",
  "level": "2",
  "url": "sec-integral-ww.html#ex-netchange-fish-population",
  "type": "Example",
  "number": "4.7.17",
  "title": "",
  "body": "  A fish population in a lake is at time . The population is changing at a rate of   fish per month, where is measured in months. What is the fish population after months?    Since is the rate of change of the population, the total change in population from to is(according to the Net Change Theorem):   Now evaluate the integral (by finding the antiderivative).   Therefore the change in population from to is,   Thus, the fish population after months is the initial population plus the change in population:   Using a calculator to approximate,   So after months, the fish population is about . If you did not have a calculator (like on an exam), you should leave the answer in the form .   "
},
{
  "id": "ex-sub-02",
  "level": "2",
  "url": "sec-integral-ww.html#ex-sub-02",
  "type": "Example",
  "number": "4.7.18",
  "title": "",
...
},
{
  "id": "ex-sub-04",
  "level": "2",
  "url": "sec-integral-ww.html#ex-sub-04",
  "type": "Example",
  "number": "4.7.19",
  "title": "",
...
},
{
  "id": "ex-sub-05",
  "level": "2",
  "url": "sec-integral-ww.html#ex-sub-05",
  "type": "Example",
  "number": "4.7.20",
  "title": "",
...
},
{
  "id": "ex-sub-06",
  "level": "2",
  "url": "sec-integral-ww.html#ex-sub-06",
  "type": "Example",
  "number": "4.7.21",
  "title": "",
  "body": "  Consider the function    Find an antiderivative of .  Evaluate .     (a) Let . Then .   (b) Now we can evaluate the definite integral:    "
}
]
