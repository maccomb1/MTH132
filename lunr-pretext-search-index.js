...
},
{
  ...
  "number": "4.7",
  "title": "Additional Worked-Out Problems",
  "body": " Additional Worked-Out Problems   Antiderivatives  test    Riemann Sums and Areas  test    Definite Integrals  test    The Fundamental Theorem of Calculus  test    Net Change Theorem and Indefinite Integrals  test    Substitution Rule for Integration    Evaluate .    Let , so and . We also solve for : gives .       Evaluate .    Let . Then , so .       Evaluate in two ways, and explain why the answers agree.    Method 1: Let . Then .   Method 2: Write the integrand as and let . Then .   These differ by a constant because . So , meaning the two antiderivative families are the same.     "
},
{
  "id": "ex-sub-02",
  "level": "2",
